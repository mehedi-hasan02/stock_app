...
`)+"void main(");else{const f=/^\s*out\s+\S+\s+\S+\s*;/gm.exec(e);f!==null&&(e=e.substring(0,f.index)+"layout(location = 0) "+e.substring(f.index))}e=e.replace(/dFdy/g,"(-yFactor_)*dFdy"),e=e.replace("##INJECTCODE##",h),c&&(e=fe(e,"void main",l))}else if("VERTEXOUTPUT_INVARIANT"in a&&(e=`invariant gl_Position;
...
`+t)}const r=this._buildLeftOverUBO();return e=r+e,t=r+t,this._collectBindingNames(),this._preCreateBindGroupEntries(),this._preProcessors=null,this._webgpuProcessingContext.vertexBufferKindToNumberOfComponents={},{vertexCode:e,fragmentCode:t}}}const _t="fragmentOutputs.fragDepth",ur="uniforms",cr="internals",lr={texture_1d:"1d",texture_2d:"2d",texture_2d_array:"2d-array",texture_3d:"3d",texture_cube:"cube",texture_cube_array:"cube-array",texture_multisampled_2d:"2d",texture_depth_2d:"2d",texture_depth_2d_array:"2d-array",texture_depth_cube:"cube",texture_depth_cube_array:"cube-array",texture_depth_multisampled_2d:"2d",texture_storage_1d:"1d",texture_storage_2d:"2d",texture_storage_2d_array:"2d-array",texture_storage_3d:"3d",texture_external:null};class hr extends P{constructor(){super(...arguments),this.shaderLanguage=1,this.uniformRegexp=/uniform\s+(\w+)\s*:\s*(.+)\s*;/,this.textureRegexp=/var\s+(\w+)\s*:\s*((array<\s*)?(texture_\w+)\s*(<\s*(.+)\s*>)?\s*(,\s*\w+\s*>\s*)?);/,this.noPrecision=!0,this.pureMode=!1}_getArraySize(e,t,r){let n=0;const i=t.lastIndexOf(">");if(t.indexOf("array")>=0&&i>0){let a=i;for(;a>0&&t.charAt(a)!==" "&&t.charAt(a)!==",";)a--;const o=t.substring(a+1,i);for(n=+o,isNaN(n)&&(n=+r[o.trim()]);a>0&&(t.charAt(a)===" "||t.charAt(a)===",");)a--;t=t.substring(t.indexOf("<")+1,a+1)}return[e,t,n]}initializeShaders(e){this._webgpuProcessingContext=e,this._attributesInputWGSL=[],this._attributesWGSL=[],this._attributesConversionCodeWGSL=[],this._hasNonFloatAttribute=!1,this._varyingsWGSL=[],this._varyingNamesWGSL=[],this._stridedUniformArrays=[]}preProcessShaderCode(e){const t=this.pureMode?"":`struct ${P.InternalsUBOName} {
  yFactor_: f32,
  textureOutputHeight_: f32,
};
var<uniform> ${cr} : ${P.InternalsUBOName};
`;return e.indexOf(t)!==-1?e:t+pe(e)}varyingCheck(e){return/(flat|linear|perspective)?\s*(center|centroid|sample)?\s*\bvarying\b/.test(e)}varyingProcessor(e,t,r){const i=/\s*(flat|linear|perspective)?\s*(center|centroid|sample)?\s*varying\s+(?:(?:highp)?|(?:lowp)?)\s*(\S+)\s*:\s*(.+)\s*;/gm.exec(e);if(i!==null){const a=i[1]??"perspective",o=i[2]??"center",u=i[4],c=i[3],l=a==="flat"?`@interpolate(${a})`:`@interpolate(${a}, ${o})`;let h;t?(h=this._webgpuProcessingContext.availableVaryings[c],h===void 0&&S.Warn(`Invalid fragment shader: The varying named "${c}" is not declared in the vertex shader! This declaration will be ignored.`)):(h=this._webgpuProcessingContext.getVaryingNextLocation(u,this._getArraySize(c,u,r)[2]),this._webgpuProcessingContext.availableVaryings[c]=h,this._varyingsWGSL.push(`  @location(${h}) ${l} ${c} : ${u},`),this._varyingNamesWGSL.push(c)),e=""}return e}attributeProcessor(e,t){const n=/\s*attribute\s+(\S+)\s*:\s*(.+)\s*;/gm.exec(e);if(n!==null){const i=n[2],a=n[1],o=this._webgpuProcessingContext.getAttributeNextLocation(i,this._getArraySize(a,i,t)[2]);this._webgpuProcessingContext.availableAttributes[a]=o,this._webgpuProcessingContext.orderedAttributes[o]=a;const u=this._webgpuProcessingContext.vertexBufferKindToNumberOfComponents[a];if(u!==void 0){const c=u<0?u===-1?"i32":"vec"+-u+"<i32>":u===1?"u32":"vec"+u+"<u32>",l=`_int_${a}_`;this._attributesInputWGSL.push(`@location(${o}) ${l} : ${c},`),this._attributesWGSL.push(`${a} : ${i},`),this._attributesConversionCodeWGSL.push(`vertexInputs.${a} = ${i}(vertexInputs_.${l});`),this._hasNonFloatAttribute=!0}else this._attributesInputWGSL.push(`@location(${o}) ${a} : ${i},`),this._attributesWGSL.push(`${a} : ${i},`),this._attributesConversionCodeWGSL.push(`vertexInputs.${a} = vertexInputs_.${a};`);e=""}return e}uniformProcessor(e,t,r){const n=this.uniformRegexp.exec(e);if(n!==null){const i=n[2],a=n[1];this._addUniformToLeftOverUBO(a,i,r),e=""}return e}textureProcessor(e,t,r){const n=this.textureRegexp.exec(e);if(n!==null){const i=n[1],a=n[2],o=!!n[3],u=n[4],c=u.indexOf("storage")>0,l=n[6],h=c?l.substring(0,l.indexOf(",")).trim():null;let d=o?this._getArraySize(i,a,r)[2]:0,f=this._webgpuProcessingContext.availableTextures[i];if(f)d=f.textures.length;else{f={isTextureArray:d>0,isStorageTexture:c,textures:[],sampleType:"float"},d=d||1;for(let m=0;m<d;++m)f.textures.push(this._webgpuProcessingContext.getNextFreeUBOBinding())}this._webgpuProcessingContext.availableTextures[i]=f;const _=u.indexOf("depth")>0,g=lr[u],p=_?"depth":l==="u32"?"uint":l==="i32"?"sint":"float";if(f.sampleType=p,g===void 0)throw`Can't get the texture dimension corresponding to the texture function "${u}"!`;for(let m=0;m<d;++m){const{groupIndex:b,bindingIndex:x}=f.textures[m];m===0&&(e=`@group(${b}) @binding(${x}) ${e}`),this._addTextureBindingDescription(i,f,m,g,h,!t)}}return e}_convertDefinesToConst(e){let t="";for(const r in e){const n=e[r];r.startsWith("__")||(!isNaN(parseInt(n))||!isNaN(parseFloat(n))?t+=`const ${r} = ${n};
`:r&&n===""&&(t+=`const ${r} = true;
...
`;const f="fragmentOutputs\\.fragData";let _=t.match(new RegExp(f+"0","g")),g=0;if(_){d+=` @location(${g}) fragData0 : vec4<f32>,
`,g++;for(let y=1;y<8;y++)_=t.match(new RegExp(f+y,"g")),_&&(d+=` @location(${g}) fragData${g} : vec4<f32>,
`,g++);t.indexOf("MRT_AND_COLOR")!==-1&&(d+=`  @location(${g}) color : vec4<f32>,
`,g++)}const p=/oitDepthSampler/;_=t.match(p),_&&(d+=` @location(${g++}) depth : vec2<f32>,
...
`,g++);let m=!1,b=0;for(;!m&&(b=t.indexOf(_t,b),!(b<0));){const y=b;for(m=!0;b>1&&t.charAt(b)!==`
`;){if(t.charAt(b)==="/"&&t.charAt(b-1)==="/"){m=!1;break}b--}b=y+_t.length}m&&(d+=`  @builtin(frag_depth) fragDepth: f32,
`),d+=`};
var<private> fragmentOutputs : FragmentOutputs;
`,t=h+d+t;const x=`  fragmentInputs = input;
  `+n,B="  return fragmentOutputs;";return l=t.indexOf("#define DISABLE_UNIFORMITY_ANALYSIS")!==-1,r.length>0&&(t="enable "+r.join(`;
enable `)+`;
`+t),t=(l?`diagnostic(off, derivative_uniformity);
`:"")+`diagnostic(off, chromium.unreachable_code);
`+fe(t,"fn main",x,B),this._collectBindingNames(),this._preCreateBindGroupEntries(),this._webgpuProcessingContext.vertexBufferKindToNumberOfComponents={},{vertexCode:e,fragmentCode:t}}_generateLeftOverUBOCode(e,t){let r="",n=`struct ${e} {
...
`}return n+=`};
`,n=`${r}
${n}`,n+=`@group(${t.binding.groupIndex}) @binding(${t.binding.bindingIndex}) var<uniform> ${ur} : ${e};
`,n}_processSamplers(e,t){const r=/var\s+(\w+Sampler)\s*:\s*(sampler|sampler_comparison)\s*;/gm;for(;;){const n=r.exec(e);if(n===null)break;const i=n[1],a=n[2],o=i.length-7,u=i.lastIndexOf("Sampler")===o?i.substring(0,o):null,c=a==="sampler_comparison"?"comparison":"filtering";if(u){const _=this._webgpuProcessingContext.availableTextures[u];_&&(_.autoBindSampler=!0)}let l=this._webgpuProcessingContext.availableSamplers[i];l||(l={binding:this._webgpuProcessingContext.getNextFreeUBOBinding(),type:c},this._webgpuProcessingContext.availableSamplers[i]=l),this._addSamplerBindingDescription(i,l,t);const h=e.substring(0,n.index),d=`@group(${l.binding.groupIndex}) @binding(${l.binding.bindingIndex}) `,f=e.substring(n.index);e=h+d+f,r.lastIndex+=d.length}return e}_processCustomBuffers(e,t){const r=/var<\s*(uniform|storage)\s*(,\s*(read|read_write)\s*)?>\s+(\S+)\s*:\s*(\S+)\s*;/gm;for(;;){const n=r.exec(e);if(n===null)break;const i=n[1],a=n[3];let o=n[4];const u=n[5];let c=this._webgpuProcessingContext.availableBuffers[o];if(!c){const g=i==="uniform"?O.KnownUBOs[u]:null;let p;g?(o=u,p=g.binding,p.groupIndex===-1&&(p=this._webgpuProcessingContext.availableBuffers[o]?.binding,p||(p=this._webgpuProcessingContext.getNextFreeUBOBinding()))):p=this._webgpuProcessingContext.getNextFreeUBOBinding(),c={binding:p},this._webgpuProcessingContext.availableBuffers[o]=c}this._addBufferBindingDescription(o,this._webgpuProcessingContext.availableBuffers[o],a==="read_write"?"storage":i==="storage"?"read-only-storage":"uniform",t);const l=c.binding.groupIndex,h=c.binding.bindingIndex,d=e.substring(0,n.index),f=`@group(${l}) @binding(${h}) `,_=e.substring(n.index);e=d+f+_,r.lastIndex+=f.length}return e}_processStridedUniformArrays(e){for(const t of this._stridedUniformArrays)e=e.replace(new RegExp(`${t}\\s*\\[(.*?)\\]`,"g"),`${t}[$1].el`);return e}}class se{get underlyingResource(){return this._webgpuTexture}getMSAATexture(e,t=0){return this._webgpuMSAATexture[t]||this._createMSAATexture(e,t),this._webgpuMSAATexture[t]}releaseMSAATextures(){for(const e of this._webgpuMSAATexture)e&&this._engine._textureHelper.releaseTexture(e);this._webgpuMSAATexture.length=0}constructor(e,t=null){this._engine=e,this._originalFormatIsRGB=!1,this.format="rgba8unorm",this.originalFormat="rgba8unorm",this.textureUsages=0,this.textureAdditionalUsages=0,this._webgpuTexture=t,this._webgpuMSAATexture=[],this.view=null,this.viewForWriting=null}set(e){this._webgpuTexture=e}setUsage(e,t,r,n,i,a,o,u){let c="2d",l=1;n?(c=r?"cube-array":"cube",l=6*(u||1)):i?(c="3d",l=1):r&&(c="2d-array",l=u);const h=I.GetDepthFormatOnly(this.format),d=I.HasDepthAndStencilAspects(this.format)?"depth-only":"all";this.createView({label:`TextureView${i?"3D":n?"Cube":"2D"}${r?"_Array"+l:""}_${a}x${o}_${t?"wmips":"womips"}_${this.format}_${c}`,format:h,dimension:c,mipLevelCount:t?It(Math.max(a,o))+1:1,baseArrayLayer:0,baseMipLevel:0,arrayLayerCount:l,aspect:d})}createView(e,t=!1){if(this.view=this._webgpuTexture.createView(e),t&&e){const r=e.mipLevelCount;e.mipLevelCount=1,this.viewForWriting=this._webgpuTexture.createView(e),e.mipLevelCount=r}}reset(){this._webgpuTexture=null,this._webgpuMSAATexture.length=0,this.view=null,this.viewForWriting=null}release(){this._webgpuTexture?.destroy(),this.releaseMSAATextures(),this._copyInvertYTempTexture?.destroy(),this.reset()}_createMSAATexture(e,t){if(!this._webgpuTexture)throw new Error("Cannot create GPU MSAA texture because underlying GPU texture is not created yet.");this._webgpuMSAATexture||(this._webgpuMSAATexture=[]),this._webgpuMSAATexture[t]=this._engine._textureHelper.createMSAATexture(this._webgpuTexture,this.originalFormat,e)}}const dr=`
    ...
    `;var U;(function(s){s[s.MipMap=0]="MipMap",s[s.InvertYPremultiplyAlpha=1]="InvertYPremultiplyAlpha",s[s.Clear=2]="Clear",s[s.InvertYPremultiplyAlphaWithOfst=3]="InvertYPremultiplyAlphaWithOfst",s[s.ResolveDepth=4]="ResolveDepth"})(U||(U={}));var j;(function(s){s[s.DontInvertY=0]="DontInvertY",s[s.InvertY=1]="InvertY"})(j||(j={}));const mt=[{vertex:dr,fragment:pr},{vertex:vt,fragment:fr},{vertex:mr,fragment:br},{vertex:gr,fragment:_r},{vertex:wr,fragment:Ir}],W={"":0,r8unorm:1,r8uint:2,r8sint:3,r16uint:4,r16sint:5,r16float:6,rg8unorm:7,rg8uint:8,rg8sint:9,r32uint:10,r32sint:11,r32float:12,rg16uint:13,rg16sint:14,rg16float:15,rgba8unorm:16,"rgba8unorm-srgb":17,rgba8uint:18,rgba8sint:19,bgra8unorm:20,"bgra8unorm-srgb":21,rgb10a2uint:22,rgb10a2unorm:23,rg32uint:24,rg32sint:25,rg32float:26,rgba16uint:27,rgba16sint:28,rgba16float:29,rgba32uint:30,rgba32sint:31,rgba32float:32,stencil8:33,depth16unorm:34,depth24plus:35,"depth24plus-stencil8":36,depth32float:37,"depth32float-stencil8":38,r16unorm:39,rg16unorm:40,rgba16unorm:41,r16snorm:42,rg16snorm:43,rgba16snorm:44};class Cr{constructor(e,t,r,n){if(this._pipelines={},this._compiledShaders=[],this._videoPipelines={},this._videoCompiledShaders=[],this._deferredReleaseTextures=[],this._engine=e,this._device=t,this._bufferManager=r,n.indexOf("rg11b10ufloat-renderable")!==-1){const i=Object.keys(W);W.rg11b10ufloat=W[i[i.length-1]]+1}this._mipmapSampler=t.createSampler({minFilter:"linear"}),this._videoSampler=t.createSampler({minFilter:"linear"}),this._ubCopyWithOfst=this._bufferManager.createBuffer(16,C.Uniform|C.CopyDst,"UBCopyWithOffset").underlyingResource,this._getPipeline("rgba8unorm"),this._getVideoPipeline("rgba8unorm")}_getPipeline(e,t=U.MipMap,r){const n=t===U.MipMap?1:t===U.InvertYPremultiplyAlpha?((r.invertY?1:0)<<1)+((r.premultiplyAlpha?1:0)<<2):t===U.Clear?8:t===U.InvertYPremultiplyAlphaWithOfst?((r.invertY?1:0)<<4)+((r.premultiplyAlpha?1:0)<<5):t===U.ResolveDepth?64:0;this._pipelines[e]||(this._pipelines[e]=[]);let i=this._pipelines[e][n];if(!i){let a="";(t===U.InvertYPremultiplyAlpha||t===U.InvertYPremultiplyAlphaWithOfst)&&(r.invertY&&(a+=`#define INVERTY
`),r.premultiplyAlpha&&(a+=`#define PREMULTIPLYALPHA
`));let o=this._compiledShaders[n];if(!o){let c=mt[t].vertex,l=mt[t].fragment;const h={defines:a.split(`
`),indexParameters:null,isFragment:!1,shouldUseHighPrecisionShader:!0,processor:this._engine._getShaderProcessor(1),supportsUniformBuffers:!0,shadersRepository:"",includesShadersStore:{},version:(this._engine.version*100).toString(),platformName:this._engine.shaderPlatformName,processingContext:this._engine._getShaderProcessingContext(1,!0),isNDCHalfZRange:this._engine.isNDCHalfZRange,useReverseDepthBuffer:this._engine.useReverseDepthBuffer};At(h),h.processor.pureMode=!0,Te(c,h,g=>{c=g},this._engine),h.isFragment=!0,Te(l,h,g=>{l=g},this._engine);const d=Mt(c,l,h);h.processor.pureMode=!1;const f=this._device.createShaderModule({label:`BabylonWebGPUDevice${this._engine.uniqueId}_InternalVertexShader_${n}`,code:d.vertexCode}),_=this._device.createShaderModule({label:`BabylonWebGPUDevice${this._engine.uniqueId}_InternalFragmentShader_${n}`,code:d.fragmentCode});o=this._compiledShaders[n]=[f,_]}const u=this._device.createRenderPipeline({label:`BabylonWebGPUDevice${this._engine.uniqueId}_InternalPipeline_${e}_${n}`,layout:"auto",vertex:{module:o[0],entryPoint:"main"},fragment:{module:o[1],entryPoint:"main",targets:[{format:e}]},primitive:{topology:"triangle-strip",stripIndexFormat:"uint16"}});i=this._pipelines[e][n]=[u,u.getBindGroupLayout(0)]}return i}_getVideoPipeline(e,t=j.DontInvertY){const r=t===j.InvertY?1:0;this._videoPipelines[e]||(this._videoPipelines[e]=[]);let n=this._videoPipelines[e][r];if(!n){let i=this._videoCompiledShaders[r];if(!i){const o=this._device.createShaderModule({code:xr,label:`BabylonWebGPUDevice${this._engine.uniqueId}_CopyVideoToTexture_VertexShader`}),u=this._device.createShaderModule({code:r===0?yr:Sr,label:`BabylonWebGPUDevice${this._engine.uniqueId}_CopyVideoToTexture_FragmentShader_${r===0?"DontInvertY":"InvertY"}`});i=this._videoCompiledShaders[r]=[o,u]}const a=this._device.createRenderPipeline({label:`BabylonWebGPUDevice${this._engine.uniqueId}_InternalVideoPipeline_${e}_${r===0?"DontInvertY":"InvertY"}`,layout:"auto",vertex:{module:i[0],entryPoint:"main"},fragment:{module:i[1],entryPoint:"main",targets:[{format:e}]},primitive:{topology:"triangle-strip",stripIndexFormat:"uint16"}});n=this._videoPipelines[e][r]=[a,a.getBindGroupLayout(0)]}return n}setCommandEncoder(e){this._commandEncoderForCreation=e}copyVideoToTexture(e,t,r,n=!1,i){const a=i===void 0,[o,u]=this._getVideoPipeline(r,n?j.InvertY:j.DontInvertY);a&&(i=this._device.createCommandEncoder({})),i.pushDebugGroup(`copy video to texture (invertY=${n})`);const c=t._hardwareTexture,l={label:`BabylonWebGPUDevice${this._engine.uniqueId}_copyVideoToTexture_${r}_${n?"InvertY":"DontInvertY"}${t.label?"_"+t.label:""}`,colorAttachments:[{view:c.underlyingResource.createView({format:r,dimension:"2d",mipLevelCount:1,baseArrayLayer:0,baseMipLevel:0,arrayLayerCount:1,aspect:"all"}),loadOp:"load",storeOp:"store"}]},h=i.beginRenderPass(l),d={layout:u,entries:[{binding:0,resource:this._videoSampler},{binding:1,resource:this._device.importExternalTexture({source:e.underlyingResource})}]},f=this._device.createBindGroup(d);h.setPipeline(o),h.setBindGroup(0,f),h.draw(4,1,0,0),h.end(),i.popDebugGroup(),a&&(this._device.queue.submit([i.finish()]),i=null)}invertYPreMultiplyAlpha(e,t,r,n,i=!1,a=!1,o=0,u=0,c=1,l=0,h=0,d=0,f=0,_,g){const p=d!==0,m=_===void 0,[b,x]=this._getPipeline(n,p?U.InvertYPremultiplyAlphaWithOfst:U.InvertYPremultiplyAlpha,{invertY:i,premultiplyAlpha:a});o=Math.max(o,0),m&&(_=this._device.createCommandEncoder({}));let B;if(I.IsHardwareTexture(e)?(B=e.underlyingResource,i&&!a&&c===1&&o===0||(e=void 0)):(B=e,e=void 0),!B)return;_.pushDebugGroup(`internal process texture "${B.label}" (invertY=${i} premultiplyAlpha=${a})`),p&&this._bufferManager.setRawData(this._ubCopyWithOfst,0,new Float32Array([l,h,d,f]),0,16);const y=e,M=y?._copyInvertYTempTexture??this.createTexture({width:t,height:r,layers:1},!1,!1,!1,!1,!1,n,1,_,21,void 0,"TempTextureForCopyWithInvertY"),R=y?._copyInvertYRenderPassDescr??{label:`BabylonWebGPUDevice${this._engine.uniqueId}_invertYPreMultiplyAlpha_${n}_${i?"InvertY":"DontInvertY"}_${a?"PremultiplyAlpha":"DontPremultiplyAlpha"}`,colorAttachments:[{view:M.createView({format:n,dimension:"2d",baseMipLevel:0,mipLevelCount:1,arrayLayerCount:1,baseArrayLayer:0}),loadOp:"load",storeOp:"store"}]},v=_.beginRenderPass(R);let L=p?y?._copyInvertYBindGroupWithOfst:y?._copyInvertYBindGroup;if(!L){const G={layout:x,entries:[{binding:0,resource:B.createView({format:n,dimension:"2d",baseMipLevel:u,mipLevelCount:1,arrayLayerCount:c,baseArrayLayer:o})}]};p&&G.entries.push({binding:1,resource:{buffer:this._ubCopyWithOfst}}),L=this._device.createBindGroup(G)}v.setPipeline(b),v.setBindGroup(0,L),v.draw(4,1,0,0),v.end(),_.copyTextureToTexture({texture:M},{texture:B,mipLevel:u,origin:{x:0,y:0,z:o}},{width:d||t,height:f||r,depthOrArrayLayers:1}),y?(y._copyInvertYTempTexture=M,y._copyInvertYRenderPassDescr=R,p?y._copyInvertYBindGroupWithOfst=L:y._copyInvertYBindGroup=L):this._deferredReleaseTextures.push([M,null]),_.popDebugGroup(),m&&(this._device.queue.submit([_.finish()]),_=null)}createTexture(e,t=!1,r=!1,n=!1,i=!1,a=!1,o="rgba8unorm",u=1,c,l=-1,h=0,d){u=I.GetSample(u);const f=e.layers||1,_={width:e.width,height:e.height,depthOrArrayLayers:f},g=W[o]?16:0,p=I.IsCompressedFormat(o),m=t?I.ComputeNumMipmapLevels(e.width,e.height):1,b=l>=0?l:7;h|=t&&!p?1|g:0,!p&&!a&&(h|=g|2);const x=this._device.createTexture({label:`BabylonWebGPUDevice${this._engine.uniqueId}_Texture${a?"3D":"2D"}_${d?d+"_":""}${_.width}x${_.height}x${_.depthOrArrayLayers}_${t?"wmips":"womips"}_${o}_samples${u}`,size:_,dimension:a?"3d":"2d",format:o,usage:b|h,sampleCount:u,mipLevelCount:m});return I.IsImageBitmap(e)&&(this.updateTexture(e,x,e.width,e.height,f,o,0,0,n,i,0,0),t&&r&&this.generateMipmaps(x,m,0,c)),x}createCubeTexture(e,t=!1,r=!1,n=!1,i=!1,a="rgba8unorm",o=1,u,c=-1,l=0,h){o=I.GetSample(o);const d=I.IsImageBitmapArray(e)?e[0].width:e.width,f=I.IsImageBitmapArray(e)?e[0].height:e.height,_=I.IsImageBitmapArray(e)?1:e.layers,g=W[a]?16:0,p=I.IsCompressedFormat(a),m=t?I.ComputeNumMipmapLevels(d,f):1,b=c>=0?c:7;l|=t&&!p?1|g:0,p||(l|=g|2);const x=this._device.createTexture({label:`BabylonWebGPUDevice${this._engine.uniqueId}_TextureCube_${h?h+"_":""}${d}x${f}x${_}_${t?"wmips":"womips"}_${a}_samples${o}`,size:{width:d,height:f,depthOrArrayLayers:6*_},dimension:"2d",format:a,usage:b|l,sampleCount:o,mipLevelCount:m});return I.IsImageBitmapArray(e)&&(this.updateCubeTextures(e,x,d,f,a,n,i,0,0),t&&r&&this.generateCubeMipmaps(x,m,u)),x}generateCubeMipmaps(e,t,r){const n=r===void 0,i=I.IsHardwareTexture(e)?e.underlyingResource:e;n&&(r=this._device.createCommandEncoder({})),r.pushDebugGroup(`create cube mipmaps for "${i.label}" (${t} levels)`);for(let a=0;a<i.depthOrArrayLayers;++a)this.generateMipmaps(e,t,a,r);r.popDebugGroup(),n&&(this._device.queue.submit([r.finish()]),r=null)}generateMipmaps(e,t,r=0,n){const i=n===void 0;r=Math.max(r,0),i&&(n=this._device.createCommandEncoder({}));let a;if(I.IsHardwareTexture(e)?(a=e.underlyingResource,e._mipmapGenRenderPassDescr=e._mipmapGenRenderPassDescr||[],e._mipmapGenBindGroup=e._mipmapGenBindGroup||[]):(a=e,e=void 0),!a)return;n.pushDebugGroup(`create mipmaps for "${a.label}" (face #${r} - ${t} levels)`);const o=a.format,[u,c]=this._getPipeline(o),l=a.dimension==="3d",h=e;for(let d=1;d<t;++d){const f=h?._mipmapGenRenderPassDescr[r]?.[d-1]??{label:`BabylonWebGPUDevice${this._engine.uniqueId}_generateMipmaps_${o}_faceIndex${r}_level${d}`,colorAttachments:[{view:a.createView({format:o,dimension:l?"3d":"2d",baseMipLevel:d,mipLevelCount:1,arrayLayerCount:1,baseArrayLayer:r}),loadOp:"load",storeOp:"store"}]};h&&(h._mipmapGenRenderPassDescr[r]=h._mipmapGenRenderPassDescr[r]||[],h._mipmapGenRenderPassDescr[r][d-1]=f);const _=n.beginRenderPass(f),g=h?._mipmapGenBindGroup[r]?.[d-1]??this._device.createBindGroup({layout:c,entries:[{binding:0,resource:a.createView({format:o,dimension:l?"3d":"2d",baseMipLevel:d-1,mipLevelCount:1,arrayLayerCount:1,baseArrayLayer:r})},{binding:1,resource:this._mipmapSampler}]});h&&(h._mipmapGenBindGroup[r]=h._mipmapGenBindGroup[r]||[],h._mipmapGenBindGroup[r][d-1]=g),_.setPipeline(u),_.setBindGroup(0,g),_.draw(4,1,0,0),_.end()}n.popDebugGroup(),i&&(this._device.queue.submit([n.finish()]),n=null)}createGPUTextureForInternalTexture(e,t,r,n,i){e._hardwareTexture||(e._hardwareTexture=new se(this._engine)),t===void 0&&(t=e.width),r===void 0&&(r=e.height),n===void 0&&(n=e.depth),e.width=e.baseWidth=t,e.height=e.baseHeight=r,e.depth=e.baseDepth=n;const a=e._hardwareTexture,o=((i??0)&1)!==0;if(a.format=a.originalFormat=I.GetWebGPUTextureFormat(e.type,e.format,e._useSRGBBuffer),e.samples>1)switch(a.format){case"depth16unorm":a.format="r16unorm";break;case"depth24plus":case"depth24plus-stencil8":case"depth32float":case"depth32float-stencil8":a.format="r32float";break}a.textureUsages=e._source===5||e.source===6?21:e._source===12?20:-1,a.textureAdditionalUsages=o?8:0;const u=e.generateMipMaps,c=n||1;let l;if(e._maxLodLevel!==null?l=e._maxLodLevel:l=u?I.ComputeNumMipmapLevels(t,r):1,e.isCube){const h=this.createCubeTexture({width:t,height:r,layers:c},e.generateMipMaps,e.generateMipMaps,e.invertY,!1,a.format,1,this._commandEncoderForCreation,a.textureUsages,a.textureAdditionalUsages,e.label);a.set(h);const d=I.GetDepthFormatOnly(a.format),f=I.HasDepthAndStencilAspects(a.format)?"depth-only":"all",_=e.is2DArray?"cube-array":"cube";a.createView({label:`BabylonWebGPUDevice${this._engine.uniqueId}_TextureViewCube${e.is2DArray?"_Array"+c:""}_${t}x${r}_${u?"wmips":"womips"}_${d}_${_}_${f}_${e.label??"noname"}`,format:d,dimension:_,mipLevelCount:l,baseArrayLayer:0,baseMipLevel:0,arrayLayerCount:6*c,aspect:f},o)}else{const h=this.createTexture({width:t,height:r,layers:c},e.generateMipMaps,e.generateMipMaps,e.invertY,!1,e.is3D,a.format,1,this._commandEncoderForCreation,a.textureUsages,a.textureAdditionalUsages,e.label);a.set(h);const d=e.is3D?1:c,f=I.GetDepthFormatOnly(a.format),_=I.HasDepthAndStencilAspects(a.format)?"depth-only":"all",g=e.is2DArray?"2d-array":e.is3D?"3d":"2d";a.createView({label:`BabylonWebGPUDevice${this._engine.uniqueId}_TextureView${e.is3D?"3D":"2D"}${e.is2DArray?"_Array"+d:""}_${t}x${r}${e.is3D?"x"+c:""}_${u?"wmips":"womips"}_${f}_${g}_${_}_${e.label??"noname"}`,format:f,dimension:g,mipLevelCount:l,baseArrayLayer:0,baseMipLevel:0,arrayLayerCount:d,aspect:_},o)}return a}createMSAATexture(e,t,r){return this.createTexture({width:e.width,height:e.height,layers:1},!1,!1,!1,!1,!1,t,r,this._commandEncoderForCreation,20,0,e.label?e.label+" (MSAA)":"MSAA")}resolveMSAADepthTexture(e,t,r){const n=t.format,i=r===void 0,[a,o]=this._getPipeline(n,U.ResolveDepth);i&&(r=this._device.createCommandEncoder({})),r.pushDebugGroup(`resolve MSAA Depth texture "${e.label}" to "${t.label}"`);const u={label:`BabylonWebGPUDevice${this._engine.uniqueId}_resolveMSAADepthTexture${e.label?"_"+e.label:""}`,colorAttachments:[{view:t,loadOp:"load",storeOp:"store"}]},c=r.beginRenderPass(u),l={layout:o,entries:[{binding:0,resource:e.createView({format:I.GetDepthFormatOnly(e.format),dimension:"2d",mipLevelCount:1,baseArrayLayer:0,baseMipLevel:0,arrayLayerCount:1,aspect:"depth-only"})}]},h=this._device.createBindGroup(l);c.setPipeline(a),c.setBindGroup(0,h),c.draw(4,1,0,0),c.end(),r.popDebugGroup(),i&&(this._device.queue.submit([r.finish()]),r=null)}updateCubeTextures(e,t,r,n,i,a=!1,o=!1,u=0,c=0){const l=[0,3,1,4,2,5];for(let h=0;h<l.length;++h){const d=e[l[h]];this.updateTexture(d,t,r,n,1,i,h,0,a,o,u,c)}}updateTexture(e,t,r,n,i,a,o=0,u=0,c=!1,l=!1,h=0,d=0,f){const _=I.IsInternalTexture(t)?t._hardwareTexture.underlyingResource:t,g=I.GetBlockInformationFromFormat(a),p=I.IsInternalTexture(t)?t._hardwareTexture:t,m={texture:_,origin:{x:h,y:d,z:Math.max(o,0)},mipLevel:u,premultipliedAlpha:l},b={width:Math.ceil(r/g.width)*g.width,height:Math.ceil(n/g.height)*g.height,depthOrArrayLayers:i||1};if(e.byteLength!==void 0){e=e;const x=Math.ceil(r/g.width)*g.length;if(Math.ceil(x/256)*256===x){const y=this._device.createCommandEncoder({}),M=this._bufferManager.createRawBuffer(e.byteLength,C.MapWrite|C.CopySrc,!0,"TempBufferForUpdateTexture"+(_?"_"+_.label:"")),R=M.getMappedRange();new Uint8Array(R).set(e),M.unmap(),y.copyBufferToTexture({buffer:M,offset:0,bytesPerRow:x,rowsPerImage:b.height/g.height},m,b),this._device.queue.submit([y.finish()]),this._bufferManager.releaseBuffer(M)}else this._device.queue.writeTexture(m,e,{offset:0,bytesPerRow:x,rowsPerImage:b.height/g.height},b);if(c||l)if(I.IsInternalTexture(t)){const y=h===0&&d===0&&r===t.width&&n===t.height;this.invertYPreMultiplyAlpha(p,t.width,t.height,a,c,l,o,u,i||1,h,d,y?0:r,y?0:n,void 0,f)}else throw"updateTexture: Can't process the texture data because a GPUTexture was provided instead of an InternalTexture!"}else e=e,this._device.queue.copyExternalImageToTexture({source:e,flipY:c},m,b)}readPixels(e,t,r,n,i,a,o=0,u=0,c=null,l=!1){const h=I.GetBlockInformationFromFormat(a),d=Math.ceil(n/h.width)*h.length,f=Math.ceil(d/256)*256,_=f*i,g=this._bufferManager.createRawBuffer(_,C.MapRead|C.CopyDst,void 0,"TempBufferForReadPixels"+(e.label?"_"+e.label:"")),p=this._device.createCommandEncoder({});return p.copyTextureToBuffer({texture:e,mipLevel:u,origin:{x:t,y:r,z:Math.max(o,0)}},{buffer:g,offset:0,bytesPerRow:f},{width:n,height:i,depthOrArrayLayers:1}),this._device.queue.submit([p.finish()]),this._bufferManager.readDataFromBuffer(g,_,n,i,d,f,I.GetTextureTypeFromFormat(a),0,c,!0,l)}releaseTexture(e){if(I.IsInternalTexture(e)){const t=e._hardwareTexture,r=e._irradianceTexture;this._deferredReleaseTextures.push([t,r])}else this._deferredReleaseTextures.push([e,null])}destroyDeferredTextures(){for(let e=0;e<this._deferredReleaseTextures.length;++e){const[t,r]=this._deferredReleaseTextures[e];t&&(I.IsHardwareTexture(t)?t.release():t.destroy()),r?.dispose()}this._deferredReleaseTextures.length=0}}class vr extends Ft{set buffer(e){this._buffer=e}constructor(e,t=0){super(),this.engineId=-1,this.capacity=t,e&&(this._buffer=e)}get underlyingResource(){return this._buffer}}class ie{static _IsGPUBuffer(e){return e.underlyingResource===void 0}static _FlagsToString(e,t=""){let r=t;for(let n=0;n<=9;++n)e&1<<n&&(r&&(r+="_"),r+=C[1<<n]);return r}constructor(e,t){this._deferredReleaseBuffers=[],this._engine=e,this._device=t}createRawBuffer(e,t,r=!1,n){const i=e.byteLength!==void 0?e.byteLength+3&-4:e+3&-4,a={label:"BabylonWebGPUDevice"+this._engine.uniqueId+"_"+ie._FlagsToString(t,n??"Buffer")+"_size"+i,mappedAtCreation:r,size:i,usage:t};return this._device.createBuffer(a)}createBuffer(e,t,r){const n=e.byteLength!==void 0,i=new vr,a="DataBufferUniqueId="+i.uniqueId;return i.buffer=this.createRawBuffer(e,t,void 0,r?a+"-"+r:a),i.references=1,i.capacity=n?e.byteLength:e,i.engineId=this._engine.uniqueId,n&&this.setSubData(i,0,e),i}setRawData(e,t,r,n,i){n+=r.byteOffset,this._device.queue.writeBuffer(e,t,r.buffer,n,i)}setSubData(e,t,r,n=0,i=0){const a=e.underlyingResource;i=i||r.byteLength-n;const o=t&3;n-=o,t-=o;const u=i;if(i=i+o+3&-4,r.buffer.byteLength-r.byteOffset<i){const l=new Uint8Array(i);l.set(new Uint8Array(r.buffer,r.byteOffset+n,u)),r=l,n=0}this.setRawData(a,t,r,n,i)}_getHalfFloatAsFloatRGBAArrayBuffer(e,t,r){r?e=Math.min(e,r.length):r=new Float32Array(e);const n=new Uint16Array(t);for(;e--;)r[e]=Pt(n[e]);return r}readDataFromBuffer(e,t,r,n,i,a,o=0,u=0,c=null,l=!0,h=!1){const d=o===1?2:o===2?1:0,f=this._engine.uniqueId;return new Promise((_,g)=>{e.mapAsync(1,u,t).then(()=>{const p=e.getMappedRange(u,t);let m=c;if(h)m===null?m=Be(o,t,!0,p):m=Be(o,m.buffer,void 0,p);else if(m===null)switch(d){case 0:m=new Uint8Array(t),m.set(new Uint8Array(p));break;case 1:m=this._getHalfFloatAsFloatRGBAArrayBuffer(t/2,p);break;case 2:m=new Float32Array(t/4),m.set(new Float32Array(p));break}else switch(d){case 0:m=new Uint8Array(m.buffer),m.set(new Uint8Array(p,0,Math.min(m.byteLength,t)));break;case 1:m=this._getHalfFloatAsFloatRGBAArrayBuffer(t/2,p,c);break;case 2:m=new Float32Array(m.buffer),m.set(new Float32Array(p,0,m.byteLength/4));break}if(i!==a){d===1&&!h&&(i*=2,a*=2);const b=new Uint8Array(m.buffer);let x=i,B=0;for(let y=1;y<n;++y){B=y*a;for(let M=0;M<i;++M)b[x++]=b[B++]}d!==0&&!h?m=new Float32Array(b.buffer,0,x/4):m=new Uint8Array(b.buffer,0,x)}e.unmap(),l&&this.releaseBuffer(e),_(m)},p=>{this._engine.isDisposed||this._engine.uniqueId!==f?_(new Uint8Array):g(p)})})}releaseBuffer(e){return ie._IsGPUBuffer(e)?(this._deferredReleaseBuffers.push(e),!0):(e.references--,e.references===0?(this._deferredReleaseBuffers.push(e.underlyingResource),!0):!1)}destroyDeferredBuffers(){for(let e=0;e<this._deferredReleaseBuffers.length;++e)this._deferredReleaseBuffers[e].destroy();this._deferredReleaseBuffers.length=0}}const Tr=[0,0,3,7,0,2,6,2,4,1,5,3,1],Br=[0,64,32,96,16,80,48,112,8],Dr=[0,128,128,0,0,0,0,128,0,0,0,0,128];class z{constructor(e){this._samplers={},this._device=e,this.disabled=!1}static GetSamplerHashCode(e){const t=e._cachedAnisotropicFilteringLevel?e._cachedAnisotropicFilteringLevel:1;return Tr[e.samplingMode]+Br[(e._comparisonFunction||514)-512+1]+Dr[e.samplingMode]+((e._cachedWrapU??1)<<8)+((e._cachedWrapV??1)<<10)+((e._cachedWrapR??1)<<12)+((e.useMipMaps?1:0)<<14)+(t<<15)}static _GetSamplerFilterDescriptor(e,t){let r,n,i,a,o;const u=e.useMipMaps;switch(e.samplingMode){case 11:r="linear",n="linear",i="nearest",u||(a=o=0);break;case 3:case 3:r="linear",n="linear",u?i="linear":(i="nearest",a=o=0);break;case 8:r="nearest",n="nearest",u?i="linear":(i="nearest",a=o=0);break;case 4:r="nearest",n="nearest",i="nearest",u||(a=o=0);break;case 5:r="nearest",n="linear",i="nearest",u||(a=o=0);break;case 6:r="nearest",n="linear",u?i="linear":(i="nearest",a=o=0);break;case 7:r="nearest",n="linear",i="nearest",a=o=0;break;case 1:case 1:r="nearest",n="nearest",i="nearest",a=o=0;break;case 9:r="linear",n="nearest",i="nearest",u||(a=o=0);break;case 10:r="linear",n="nearest",u?i="linear":(i="nearest",a=o=0);break;case 2:case 2:r="linear",n="linear",t>1?i="linear":(i="nearest",a=o=0);break;case 12:r="linear",n="nearest",i="nearest",a=o=0;break;default:r="nearest",n="nearest",i="nearest",a=o=0;break}return t>1&&(a!==0||o!==0)?{magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",anisotropyEnabled:!0}:{magFilter:r,minFilter:n,mipmapFilter:i,lodMinClamp:a,lodMaxClamp:o}}static _GetWrappingMode(e){switch(e){case 1:return"repeat";case 0:return"clamp-to-edge";case 2:return"mirror-repeat"}return"repeat"}static _GetSamplerWrappingDescriptor(e){return{addressModeU:this._GetWrappingMode(e._cachedWrapU),addressModeV:this._GetWrappingMode(e._cachedWrapV),addressModeW:this._GetWrappingMode(e._cachedWrapR)}}static _GetSamplerDescriptor(e,t){let r=(e.useMipMaps||e.samplingMode===2)&&e._cachedAnisotropicFilteringLevel?e._cachedAnisotropicFilteringLevel:1;e.samplingMode!==11&&e.samplingMode!==3&&e.samplingMode!==2&&(r=1);const n=this._GetSamplerFilterDescriptor(e,r);return{label:t,...n,...this._GetSamplerWrappingDescriptor(e),compare:e._comparisonFunction?z.GetCompareFunction(e._comparisonFunction):void 0,maxAnisotropy:n.anisotropyEnabled?r:1}}static GetCompareFunction(e){switch(e){case 519:return"always";case 514:return"equal";case 516:return"greater";case 518:return"greater-equal";case 513:return"less";case 515:return"less-equal";case 512:return"never";case 517:return"not-equal";default:return"less"}}getSampler(e,t=!1,r=0,n){if(this.disabled)return this._device.createSampler(z._GetSamplerDescriptor(e,n));t?r=0:r===0&&(r=z.GetSamplerHashCode(e));let i=t?void 0:this._samplers[r];return i||(i=this._device.createSampler(z._GetSamplerDescriptor(e,n)),t||(this._samplers[r]=i)),i}}const Rr={[w.PositionKind]:!0,[w.NormalKind]:!0,[w.TangentKind]:!0,[w.UVKind]:!0,[w.UV2Kind]:!0,[w.UV3Kind]:!0,[w.UV4Kind]:!0,[w.UV5Kind]:!0,[w.UV6Kind]:!0,[w.ColorKind]:!0,[w.ColorInstanceKind]:!0,[w.MatricesIndicesKind]:!0,[w.MatricesWeightsKind]:!0,[w.MatricesIndicesExtraKind]:!0,[w.MatricesWeightsExtraKind]:!0};function Ar(s){switch(s){case w.BYTE:case w.SHORT:case w.INT:case w.FLOAT:return!0;case w.UNSIGNED_BYTE:case w.UNSIGNED_SHORT:case w.UNSIGNED_INT:return!1;default:throw new Error(`Invalid type '${s}'`)}}function Mr(s,e){const t=e.getEngine(),r=e._pipelineContext;if(!r?.vertexBufferKindToType)return;let n=null;for(const i in s){const a=s[i];if(!a||!Rr[i])continue;const o=a.normalized?w.FLOAT:a.type,u=r.vertexBufferKindToType[i];(o!==w.FLOAT&&u===void 0||u!==void 0&&u!==o)&&(n||(n=t._getShaderProcessingContext(e.shaderLanguage,!1)),r.vertexBufferKindToType[i]=o,o!==w.FLOAT&&(n.vertexBufferKindToNumberOfComponents[i]=w.DeduceStride(i),Ar(o)&&(n.vertexBufferKindToNumberOfComponents[i]*=-1)))}if(n){const i=t._caps.parallelShaderCompile;t._caps.parallelShaderCompile=void 0,e._processShaderCodeAsync(null,t._features._checkNonFloatVertexBuffersDontRecreatePipelineContext,n),t._caps.parallelShaderCompile=i}}var F;(function(s){s[s.StencilReadMask=0]="StencilReadMask",s[s.StencilWriteMask=1]="StencilWriteMask",s[s.DepthBias=2]="DepthBias",s[s.DepthBiasSlopeScale=3]="DepthBiasSlopeScale",s[s.DepthStencilState=4]="DepthStencilState",s[s.MRTAttachments=5]="MRTAttachments",s[s.RasterizationState=6]="RasterizationState",s[s.ColorStates1=7]="ColorStates1",s[s.ColorStates2=8]="ColorStates2",s[s.ColorStates3=9]="ColorStates3",s[s.ColorStates4=10]="ColorStates4",s[s.ShaderStage=11]="ShaderStage",s[s.TextureStage=12]="TextureStage",s[s.VertexState=13]="VertexState",s[s.NumStates=14]="NumStates"})(F||(F={}));const te={0:1,1:2,768:3,769:4,770:5,771:6,772:7,773:8,774:9,775:10,776:11,32769:12,32770:13,32771:14,32772:15,35065:16,35066:17,34185:18,35067:19},bt={32774:0,32775:1,32776:2,32778:3,32779:4},$={0:0,7680:1,7681:2,7682:3,7683:4,5386:5,34055:6,34056:7},Y=[0,0,0,0];class D{constructor(e,t){this.mrtTextureCount=0,this._device=e,this._useTextureStage=!0,this._states=new Array(30),this._statesLength=0,this._stateDirtyLowestIndex=0,this._emptyVertexBuffer=t,this._mrtFormats=[],this._parameter={token:void 0,pipeline:null},this.disabled=!1,this.vertexBuffers=[],this._kMaxVertexBufferStride=e.limits.maxVertexBufferArrayStride||2048,this.reset()}reset(){this._isDirty=!0,this.vertexBuffers.length=0,this.setAlphaToCoverage(!1),this.resetDepthCullingState(),this.setClampDepth(!1),this.setDepthBias(0),this._webgpuColorFormat=["bgra8unorm"],this.setColorFormat("bgra8unorm"),this.setMRT([]),this.setAlphaBlendEnabled([!1],1),this.setAlphaBlendFactors([null,null,null,null],[null,null]),this.setWriteMask(15),this.setDepthStencilFormat("depth24plus-stencil8"),this.setStencilEnabled(!1),this.resetStencilState(),this.setBuffers(null,null,null),this._setTextureState(0)}get colorFormats(){return this._mrtAttachments>0?this._mrtFormats:this._webgpuColorFormat}getRenderPipeline(e,t,r,n=0){if(r=I.GetSample(r),this.disabled){const a=D._GetTopology(e);return this._setVertexState(t),this._setTextureState(n),this._parameter.pipeline=this._createRenderPipeline(t,a,r),D.NumCacheMiss++,D._NumPipelineCreationCurrentFrame++,this._parameter.pipeline}if(this._setShaderStage(t.uniqueId),this._setRasterizationState(e,r),this._setColorStates(),this._setDepthStencilState(),this._setVertexState(t),this._setTextureState(n),this.lastStateDirtyLowestIndex=this._stateDirtyLowestIndex,!this._isDirty&&this._parameter.pipeline)return this._stateDirtyLowestIndex=this._statesLength,D.NumCacheHitWithoutHash++,this._parameter.pipeline;if(this._getRenderPipeline(this._parameter),this._isDirty=!1,this._stateDirtyLowestIndex=this._statesLength,this._parameter.pipeline)return D.NumCacheHitWithHash++,this._parameter.pipeline;const i=D._GetTopology(e);return this._parameter.pipeline=this._createRenderPipeline(t,i,r),this._setRenderPipeline(this._parameter),D.NumCacheMiss++,D._NumPipelineCreationCurrentFrame++,this._parameter.pipeline}endFrame(){D.NumPipelineCreationLastFrame=D._NumPipelineCreationCurrentFrame,D._NumPipelineCreationCurrentFrame=0}setAlphaToCoverage(e){this._alphaToCoverageEnabled=e}setFrontFace(e){this._frontFace=e}setCullEnabled(e){this._cullEnabled=e}setCullFace(e){this._cullFace=e}setClampDepth(e){this._clampDepth=e}resetDepthCullingState(){this.setDepthCullingState(!1,2,1,0,0,!0,!0,519)}setDepthCullingState(e,t,r,n,i,a,o,u){this._depthWriteEnabled=o,this._depthTestEnabled=a,this._depthCompare=(u??519)-512,this._cullFace=r,this._cullEnabled=e,this._frontFace=t,this.setDepthBiasSlopeScale(n),this.setDepthBias(i)}setDepthBias(e){this._depthBias!==e&&(this._depthBias=e,this._states[F.DepthBias]=e,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.DepthBias))}setDepthBiasSlopeScale(e){this._depthBiasSlopeScale!==e&&(this._depthBiasSlopeScale=e,this._states[F.DepthBiasSlopeScale]=e,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.DepthBiasSlopeScale))}setColorFormat(e){this._webgpuColorFormat[0]=e,this._colorFormat=W[e??""]}setMRTAttachments(e){this.mrtAttachments=e;let t=0;for(let r=0;r<e.length;++r)e[r]!==0&&(t+=1<<r);this._mrtEnabledMask!==t&&(this._mrtEnabledMask=t,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.MRTAttachments))}setMRT(e,t){if(t=t??e.length,t>8)throw new Error("Can't handle more than 8 attachments for a MRT in cache render pipeline!");this.mrtTextureArray=e,this.mrtTextureCount=t,this._mrtEnabledMask=65535;let r=0,n=0;for(let i=0;i<t;++i){const o=e[i]?._hardwareTexture;this._mrtFormats[i]=o?.format??this._webgpuColorFormat[0],r+=W[this._mrtFormats[i]??""]*2**n,n+=6}this._mrtFormats.length=t,this._mrtAttachments!==r&&(this._mrtAttachments=r,this._states[F.MRTAttachments]=r,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.MRTAttachments))}setAlphaBlendEnabled(e,t){this._alphaBlendEnabled=e,this._numAlphaBlendTargetsEnabled=t}setAlphaBlendFactors(e,t){this._alphaBlendFuncParams=e,this._alphaBlendEqParams=t}setWriteMask(e){this._writeMask=e}setDepthStencilFormat(e){this._webgpuDepthStencilFormat=e,this._depthStencilFormat=e===void 0?0:W[e]}setDepthTestEnabled(e){this._depthTestEnabled=e}setDepthWriteEnabled(e){this._depthWriteEnabled=e}setDepthCompare(e){this._depthCompare=(e??519)-512}setStencilEnabled(e){this._stencilEnabled=e}setStencilCompare(e){this._stencilFrontCompare=(e??519)-512}setStencilDepthFailOp(e){this._stencilFrontDepthFailOp=e===null?1:$[e]}setStencilPassOp(e){this._stencilFrontPassOp=e===null?2:$[e]}setStencilFailOp(e){this._stencilFrontFailOp=e===null?1:$[e]}setStencilBackCompare(e){this._stencilBackCompare=(e??519)-512}setStencilBackDepthFailOp(e){this._stencilBackDepthFailOp=e===null?1:$[e]}setStencilBackPassOp(e){this._stencilBackPassOp=e===null?2:$[e]}setStencilBackFailOp(e){this._stencilBackFailOp=e===null?1:$[e]}setStencilReadMask(e){this._stencilReadMask!==e&&(this._stencilReadMask=e,this._states[F.StencilReadMask]=e,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.StencilReadMask))}setStencilWriteMask(e){this._stencilWriteMask!==e&&(this._stencilWriteMask=e,this._states[F.StencilWriteMask]=e,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.StencilWriteMask))}resetStencilState(){this.setStencilState(!1,519,7680,7681,7680,255,255)}setStencilState(e,t,r,n,i,a,o,u=null,c=null,l=null,h=null){this._stencilEnabled=e,this._stencilFrontCompare=(t??519)-512,this._stencilFrontDepthFailOp=r===null?1:$[r],this._stencilFrontPassOp=n===null?2:$[n],this._stencilFrontFailOp=i===null?1:$[i],this._stencilBackCompare=(u??519)-512,this._stencilBackDepthFailOp=c===null?1:$[c],this._stencilBackPassOp=l===null?2:$[l],this._stencilBackFailOp=h===null?1:$[h],this.setStencilReadMask(a),this.setStencilWriteMask(o)}setBuffers(e,t,r){this._vertexBuffers=e,this._overrideVertexBuffers=r,this.indexBuffer=t}static _GetTopology(e){switch(e){case 0:return"triangle-list";case 2:return"point-list";case 1:return"line-list";case 3:return"point-list";case 4:return"line-list";case 5:throw"LineLoop is an unsupported fillmode in WebGPU";case 6:return"line-strip";case 7:return"triangle-strip";case 8:throw"TriangleFan is an unsupported fillmode in WebGPU";default:return"triangle-list"}}static _GetAphaBlendOperation(e){switch(e){case 32774:return"add";case 32778:return"subtract";case 32779:return"reverse-subtract";case 32775:return"min";case 32776:return"max";default:return"add"}}static _GetAphaBlendFactor(e){switch(e){case 0:return"zero";case 1:return"one";case 768:return"src";case 769:return"one-minus-src";case 770:return"src-alpha";case 771:return"one-minus-src-alpha";case 772:return"dst-alpha";case 773:return"one-minus-dst-alpha";case 774:return"dst";case 775:return"one-minus-dst";case 776:return"src-alpha-saturated";case 32769:case 32771:return"constant";case 32770:case 32772:return"one-minus-constant";case 35065:return"src1";case 35066:return"one-minus-src1";case 34185:return"src1-alpha";case 35067:return"one-minus-src1-alpha";default:return"one"}}static _GetCompareFunction(e){switch(e){case 0:return"never";case 1:return"less";case 2:return"equal";case 3:return"less-equal";case 4:return"greater";case 5:return"not-equal";case 6:return"greater-equal";case 7:return"always"}return"never"}static _GetStencilOpFunction(e){switch(e){case 0:return"zero";case 1:return"keep";case 2:return"replace";case 3:return"increment-clamp";case 4:return"decrement-clamp";case 5:return"invert";case 6:return"increment-wrap";case 7:return"decrement-wrap"}return"keep"}static _GetVertexInputDescriptorFormat(e){const t=e.type,r=e.normalized,n=e.getSize();switch(t){case w.BYTE:switch(n){case 1:case 2:return r?"snorm8x2":"sint8x2";case 3:case 4:return r?"snorm8x4":"sint8x4"}break;case w.UNSIGNED_BYTE:switch(n){case 1:case 2:return r?"unorm8x2":"uint8x2";case 3:case 4:return r?"unorm8x4":"uint8x4"}break;case w.SHORT:switch(n){case 1:case 2:return r?"snorm16x2":"sint16x2";case 3:case 4:return r?"snorm16x4":"sint16x4"}break;case w.UNSIGNED_SHORT:switch(n){case 1:case 2:return r?"unorm16x2":"uint16x2";case 3:case 4:return r?"unorm16x4":"uint16x4"}break;case w.INT:switch(n){case 1:return"sint32";case 2:return"sint32x2";case 3:return"sint32x3";case 4:return"sint32x4"}break;case w.UNSIGNED_INT:switch(n){case 1:return"uint32";case 2:return"uint32x2";case 3:return"uint32x3";case 4:return"uint32x4"}break;case w.FLOAT:switch(n){case 1:return"float32";case 2:return"float32x2";case 3:return"float32x3";case 4:return"float32x4"}break}throw new Error(`Invalid Format '${e.getKind()}' - type=${t}, normalized=${r}, size=${n}`)}_getAphaBlendState(e){return this._alphaBlendEnabled[e]?{srcFactor:D._GetAphaBlendFactor(this._alphaBlendFuncParams[e*4+2]),dstFactor:D._GetAphaBlendFactor(this._alphaBlendFuncParams[e*4+3]),operation:D._GetAphaBlendOperation(this._alphaBlendEqParams[e*2+1])}:null}_getColorBlendState(e){return this._alphaBlendEnabled?{srcFactor:D._GetAphaBlendFactor(this._alphaBlendFuncParams[e*4+0]),dstFactor:D._GetAphaBlendFactor(this._alphaBlendFuncParams[e*4+1]),operation:D._GetAphaBlendOperation(this._alphaBlendEqParams[e*2+0])}:null}_setShaderStage(e){this._shaderId!==e&&(this._shaderId=e,this._states[F.ShaderStage]=e,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.ShaderStage))}_setRasterizationState(e,t){const r=this._frontFace,n=this._cullEnabled?this._cullFace:0,i=this._clampDepth?1:0,a=this._alphaToCoverageEnabled?1:0,o=r-1+(n<<1)+(i<<3)+(a<<4)+(e<<5)+(t<<8);this._rasterizationState!==o&&(this._rasterizationState=o,this._states[F.RasterizationState]=this._rasterizationState,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.RasterizationState))}_setColorStates(){Y[0]=(this._writeMask?1:0)*2**53,Y[1]=(this._depthWriteEnabled?1:0)*2**53,Y[2]=(this._colorFormat&7)*2**50,Y[3]=(this._colorFormat&56)*2**47;let e=0,t=!1;for(let r=0;r<8;r++){if(this._alphaBlendEnabled[r]){const n=r*4+0,i=r*4+1,a=r*4+2,o=r*4+3,u=r*2+0,c=r*2+1,l=this._alphaBlendEqParams[u]===null?0:bt[this._alphaBlendEqParams[u]],h=this._alphaBlendEqParams[c]===null?0:bt[this._alphaBlendEqParams[c]];Y[e]+=((this._alphaBlendFuncParams[n]===null?1:te[this._alphaBlendFuncParams[n]])<<0)+((this._alphaBlendFuncParams[i]===null?1:te[this._alphaBlendFuncParams[i]])<<5)+((this._alphaBlendFuncParams[a]===null?1:te[this._alphaBlendFuncParams[a]])<<10)+((this._alphaBlendFuncParams[o]===null?1:te[this._alphaBlendFuncParams[o]])<<15)+(l+h*5)*(1<<20)}r&1&&(t=t||this._states[F.ColorStates1+e]!==Y[e],this._states[F.ColorStates1+e]=Y[e],e++)}t&&(this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.ColorStates1))}_setDepthStencilState(){const e=this._stencilEnabled?this._stencilFrontCompare+(this._stencilFrontDepthFailOp<<3)+(this._stencilFrontPassOp<<6)+(this._stencilFrontFailOp<<9)+(this._stencilBackCompare<<12)+(this._stencilBackDepthFailOp<<15)+(this._stencilBackPassOp<<18)+(this._stencilBackFailOp<<21):2421327,t=this._depthStencilFormat+((this._depthTestEnabled?this._depthCompare:7)<<6)+e*1024;this._depthStencilState!==t&&(this._depthStencilState=t,this._states[F.DepthStencilState]=this._depthStencilState,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.DepthStencilState))}_setVertexState(e){const t=this._statesLength;let r=F.VertexState;const n=e._pipelineContext,i=n.shaderProcessingContext.attributeNamesFromEffect,a=n.shaderProcessingContext.attributeLocationsFromEffect;let o,u=0;for(let c=0;c<i.length;c++){const l=a[c];let h=(this._overrideVertexBuffers&&this._overrideVertexBuffers[i[c]])??this._vertexBuffers[i[c]];h||(h=this._emptyVertexBuffer,D.LogErrorIfNoVertexBuffer&&S.Error(`No vertex buffer is provided for the "${i[c]}" attribute. A default empty vertex buffer will be used, but this may generate errors in some browsers.`));const d=h.effectiveBuffer?.underlyingResource;if(h._validOffsetRange===void 0){const _=h.effectiveByteOffset,g=h.getSize(!0),p=h.effectiveByteStride;h._validOffsetRange=_+g<=this._kMaxVertexBufferStride&&p===0||p!==0&&_+g<=p}o&&o===d&&h._validOffsetRange||(this.vertexBuffers[u++]=h,o=h._validOffsetRange?d:null);const f=h.hashCode+(l<<7);this._isDirty=this._isDirty||this._states[r]!==f,this._states[r++]=f}this.vertexBuffers.length=u,this._statesLength=r,this._isDirty=this._isDirty||r!==t,this._isDirty&&(this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.VertexState))}_setTextureState(e){this._textureState!==e&&(this._textureState=e,this._states[F.TextureStage]=this._textureState,this._isDirty=!0,this._stateDirtyLowestIndex=Math.min(this._stateDirtyLowestIndex,F.TextureStage))}_createPipelineLayout(e){if(this._useTextureStage)return this._createPipelineLayoutWithTextureStage(e);const t=[],r=e.shaderProcessingContext.bindGroupLayoutEntries;for(let n=0;n<r.length;n++){const i=r[n];t[n]=this._device.createBindGroupLayout({entries:i})}return e.bindGroupLayouts[0]=t,this._device.createPipelineLayout({bindGroupLayouts:t})}_createPipelineLayoutWithTextureStage(e){const t=e.shaderProcessingContext,r=t.bindGroupLayoutEntries;let n=1;for(let a=0;a<r.length;a++){const o=r[a];for(let u=0;u<o.length;u++){const c=r[a][u];if(c.texture){const l=t.bindGroupLayoutEntryInfo[a][c.binding].name,h=t.availableTextures[l],d=h.autoBindSampler?t.availableSamplers[l+"Sampler"]:null;let f=h.sampleType,_=d?.type??"filtering";if(this._textureState&n&&f!=="depth"&&(h.autoBindSampler&&(_="non-filtering"),f="unfilterable-float"),c.texture.sampleType=f,d){const g=t.bindGroupLayoutEntryInfo[d.binding.groupIndex][d.binding.bindingIndex].index;r[d.binding.groupIndex][g].sampler.type=_}n=n<<1}}}const i=[];for(let a=0;a<r.length;++a)i[a]=this._device.createBindGroupLayout({entries:r[a]});return e.bindGroupLayouts[this._textureState]=i,this._device.createPipelineLayout({bindGroupLayouts:i})}_getVertexInputDescriptor(e){const t=[],r=e._pipelineContext,n=r.shaderProcessingContext.attributeNamesFromEffect,i=r.shaderProcessingContext.attributeLocationsFromEffect;let a,o;for(let u=0;u<n.length;u++){const c=i[u];let l=(this._overrideVertexBuffers&&this._overrideVertexBuffers[n[u]])??this._vertexBuffers[n[u]];l||(l=this._emptyVertexBuffer);let h=l.effectiveBuffer?.underlyingResource,d=l.effectiveByteOffset;const f=!l._validOffsetRange;if(!(a&&o&&a===h)||f){const _={arrayStride:l.effectiveByteStride,stepMode:l.getIsInstanced()?"instance":"vertex",attributes:[]};t.push(_),o=_.attributes,f&&(d=0,h=null)}o.push({shaderLocation:c,offset:d,format:D._GetVertexInputDescriptorFormat(l)}),a=h}return t}_createRenderPipeline(e,t,r){const n=e._pipelineContext,i=this._getVertexInputDescriptor(e),a=this._createPipelineLayout(n),o=[];if(this._vertexBuffers&&Mr(this._vertexBuffers,e),this._mrtAttachments>0)for(let f=0;f<this._mrtFormats.length;++f){const _=this._mrtFormats[f];if(_){const g={format:_,writeMask:(this._mrtEnabledMask&1<<f)!==0?this._writeMask:0},p=this._getAphaBlendState(f<this._numAlphaBlendTargetsEnabled?f:0),m=this._getColorBlendState(f<this._numAlphaBlendTargetsEnabled?f:0);p&&m&&(g.blend={alpha:p,color:m}),o.push(g)}else o.push(null)}else if(this._webgpuColorFormat[0]){const f={format:this._webgpuColorFormat[0],writeMask:this._writeMask},_=this._getAphaBlendState(0),g=this._getColorBlendState(0);_&&g&&(f.blend={alpha:_,color:g}),o.push(f)}else o.push(null);const u={compare:D._GetCompareFunction(this._stencilEnabled?this._stencilFrontCompare:7),depthFailOp:D._GetStencilOpFunction(this._stencilEnabled?this._stencilFrontDepthFailOp:1),failOp:D._GetStencilOpFunction(this._stencilEnabled?this._stencilFrontFailOp:1),passOp:D._GetStencilOpFunction(this._stencilEnabled?this._stencilFrontPassOp:1)},c={compare:D._GetCompareFunction(this._stencilEnabled?this._stencilBackCompare:7),depthFailOp:D._GetStencilOpFunction(this._stencilEnabled?this._stencilBackDepthFailOp:1),failOp:D._GetStencilOpFunction(this._stencilEnabled?this._stencilBackFailOp:1),passOp:D._GetStencilOpFunction(this._stencilEnabled?this._stencilBackPassOp:1)},l=t==="triangle-list"||t==="triangle-strip";let h;(t==="line-strip"||t==="triangle-strip")&&(h=!this.indexBuffer||this.indexBuffer.is32Bits?"uint32":"uint16");const d=this._webgpuDepthStencilFormat?I.HasStencilAspect(this._webgpuDepthStencilFormat):!1;return this._device.createRenderPipeline({label:`RenderPipeline_${o[0]?.format??"nooutput"}_${this._webgpuDepthStencilFormat??"nodepth"}_samples${r}_textureState${this._textureState}`,layout:a,vertex:{module:n.stages.vertexStage.module,entryPoint:n.stages.vertexStage.entryPoint,buffers:i},primitive:{topology:t,stripIndexFormat:h,frontFace:this._frontFace===1?"ccw":"cw",cullMode:this._cullEnabled?this._cullFace===2?"front":"back":"none"},fragment:n.stages.fragmentStage?{module:n.stages.fragmentStage.module,entryPoint:n.stages.fragmentStage.entryPoint,targets:o}:void 0,multisample:{count:r},depthStencil:this._webgpuDepthStencilFormat===void 0?void 0:{depthWriteEnabled:this._depthWriteEnabled,depthCompare:this._depthTestEnabled?D._GetCompareFunction(this._depthCompare):"always",format:this._webgpuDepthStencilFormat,stencilFront:this._stencilEnabled&&d?u:void 0,stencilBack:this._stencilEnabled&&d?c:void 0,stencilReadMask:this._stencilEnabled&&d?this._stencilReadMask:void 0,stencilWriteMask:this._stencilEnabled&&d?this._stencilWriteMask:void 0,depthBias:this._depthBias,depthBiasClamp:l?this._depthBiasClamp:0,depthBiasSlopeScale:l?this._depthBiasSlopeScale:0}})}}D.LogErrorIfNoVertexBuffer=!1;D.NumCacheHitWithoutHash=0;D.NumCacheHitWithHash=0;D.NumCacheMiss=0;D.NumPipelineCreationLastFrame=0;D._NumPipelineCreationCurrentFrame=0;class ge{constructor(){this.values={}}count(){let e=0,t=this.pipeline?1:0;for(const r in this.values){const n=this.values[r],[i,a]=n.count();e+=i,t+=a,e++}return[e,t]}}class k extends D{static GetNodeCounts(){const e=k._Cache.count();return{nodeCount:e[0],pipelineCount:e[1]}}static _GetPipelines(e,t,r,n){if(e.pipeline){const i=r.slice();i.length=n,t.push(i)}for(const i in e.values){const a=e.values[i];r[n]=parseInt(i),k._GetPipelines(a,t,r,n+1)}}static GetPipelines(){const e=[];return k._GetPipelines(k._Cache,e,[],0),e}static ResetCache(){k._Cache=new ge}reset(){this._nodeStack=[],this._nodeStack[0]=k._Cache,super.reset()}_getRenderPipeline(e){let t=this._nodeStack[this._stateDirtyLowestIndex];for(let r=this._stateDirtyLowestIndex;r<this._statesLength;++r){let n=t.values[this._states[r]];n||(n=new ge,t.values[this._states[r]]=n),t=n,this._nodeStack[r+1]=t}e.token=t,e.pipeline=t.pipeline}_setRenderPipeline(e){e.token.pipeline=e.pipeline}}k._Cache=new ge;class Fr extends Lt{constructor(e){super(!1),this._cache=e,this.reset()}get func(){return this._func}set func(e){this._func!==e&&(this._func=e,this._cache.setStencilCompare(e))}get backFunc(){return this._backFunc}set backFunc(e){this._backFunc!==e&&(this._backFunc=e,this._cache.setStencilBackCompare(e))}get funcMask(){return this._funcMask}set funcMask(e){this._funcMask!==e&&(this._funcMask=e,this._cache.setStencilReadMask(e))}get opStencilFail(){return this._opStencilFail}set opStencilFail(e){this._opStencilFail!==e&&(this._opStencilFail=e,this._cache.setStencilFailOp(e))}get opDepthFail(){return this._opDepthFail}set opDepthFail(e){this._opDepthFail!==e&&(this._opDepthFail=e,this._cache.setStencilDepthFailOp(e))}get opStencilDepthPass(){return this._opStencilDepthPass}set opStencilDepthPass(e){this._opStencilDepthPass!==e&&(this._opStencilDepthPass=e,this._cache.setStencilPassOp(e))}get backOpStencilFail(){return this._backOpStencilFail}set backOpStencilFail(e){this._backOpStencilFail!==e&&(this._backOpStencilFail=e,this._cache.setStencilBackFailOp(e))}get backOpDepthFail(){return this._backOpDepthFail}set backOpDepthFail(e){this._backOpDepthFail!==e&&(this._backOpDepthFail=e,this._cache.setStencilBackDepthFailOp(e))}get backOpStencilDepthPass(){return this._backOpStencilDepthPass}set backOpStencilDepthPass(e){this._backOpStencilDepthPass!==e&&(this._backOpStencilDepthPass=e,this._cache.setStencilBackPassOp(e))}get mask(){return this._mask}set mask(e){this._mask!==e&&(this._mask=e,this._cache.setStencilWriteMask(e))}get enabled(){return this._enabled}set enabled(e){this._enabled!==e&&(this._enabled=e,this._cache.setStencilEnabled(e))}reset(){super.reset(),this._cache.resetStencilState()}apply(){const e=!this.useStencilGlobalOnly&&!!this.stencilMaterial?.enabled;this.enabled=e?this.stencilMaterial.enabled:this.stencilGlobal.enabled,this.enabled&&(this.mask=e?this.stencilMaterial.mask:this.stencilGlobal.mask,this.funcRef=e?this.stencilMaterial.funcRef:this.stencilGlobal.funcRef,this.funcMask=e?this.stencilMaterial.funcMask:this.stencilGlobal.funcMask,this.func=e?this.stencilMaterial.func:this.stencilGlobal.func,this.opStencilFail=e?this.stencilMaterial.opStencilFail:this.stencilGlobal.opStencilFail,this.opDepthFail=e?this.stencilMaterial.opDepthFail:this.stencilGlobal.opDepthFail,this.opStencilDepthPass=e?this.stencilMaterial.opStencilDepthPass:this.stencilGlobal.opStencilDepthPass,this.backFunc=e?this.stencilMaterial.backFunc:this.stencilGlobal.backFunc,this.backOpStencilFail=e?this.stencilMaterial.backOpStencilFail:this.stencilGlobal.backOpStencilFail,this.backOpDepthFail=e?this.stencilMaterial.backOpDepthFail:this.stencilGlobal.backOpDepthFail,this.backOpStencilDepthPass=e?this.stencilMaterial.backOpStencilDepthPass:this.stencilGlobal.backOpStencilDepthPass)}}class Pr extends Et{constructor(e){super(!1),this._cache=e,this.reset()}get zOffset(){return this._zOffset}set zOffset(e){this._zOffset!==e&&(this._zOffset=e,this._isZOffsetDirty=!0,this._cache.setDepthBiasSlopeScale(e))}get zOffsetUnits(){return this._zOffsetUnits}set zOffsetUnits(e){this._zOffsetUnits!==e&&(this._zOffsetUnits=e,this._isZOffsetDirty=!0,this._cache.setDepthBias(e))}get cullFace(){return this._cullFace}set cullFace(e){this._cullFace!==e&&(this._cullFace=e,this._isCullFaceDirty=!0,this._cache.setCullFace(e??1))}get cull(){return this._cull}set cull(e){this._cull!==e&&(this._cull=e,this._isCullDirty=!0,this._cache.setCullEnabled(!!e))}get depthFunc(){return this._depthFunc}set depthFunc(e){this._depthFunc!==e&&(this._depthFunc=e,this._isDepthFuncDirty=!0,this._cache.setDepthCompare(e))}get depthMask(){return this._depthMask}set depthMask(e){this._depthMask!==e&&(this._depthMask=e,this._isDepthMaskDirty=!0,this._cache.setDepthWriteEnabled(e))}get depthTest(){return this._depthTest}set depthTest(e){this._depthTest!==e&&(this._depthTest=e,this._isDepthTestDirty=!0,this._cache.setDepthTestEnabled(e))}get frontFace(){return this._frontFace}set frontFace(e){this._frontFace!==e&&(this._frontFace=e,this._isFrontFaceDirty=!0,this._cache.setFrontFace(e??2))}reset(){super.reset(),this._cache.resetDepthCullingState()}apply(){}}class Tt{static IsExternalTexture(e){return e.underlyingResource!==void 0}getClassName(){return"ExternalTexture"}get underlyingResource(){return this._video}constructor(e){this.useMipMaps=!1,this.type=16,this.format=4294967295,this._video=e,this.uniqueId=q._Counter++}isReady(){return this._video.readyState>=this._video.HAVE_CURRENT_DATA}dispose(){}}class oe{get forceBindGroupCreation(){return this._numExternalTextures>0}get hasFloatOrDepthTextures(){return this._numFloatOrDepthTextures>0}constructor(){this.useVertexPulling=!1,this.uniqueId=oe._Counter++,this.updateId=0,this.textureState=0,this.reset()}reset(){this.samplers={},this.textures={},this.isDirty=!0,this._numFloatOrDepthTextures=0,this._numExternalTextures=0}setSampler(e,t){let r=this.samplers[e],n=-1;r?n=r.hashCode:this.samplers[e]=r={sampler:t,hashCode:0},r.sampler=t,r.hashCode=t?z.GetSamplerHashCode(t):0;const i=n!==r.hashCode;i&&this.updateId++,this.isDirty||(this.isDirty=i)}setTexture(e,t){let r=this.textures[e],n=-1;r?n=r.texture?.uniqueId??-1:this.textures[e]=r={texture:t,isFloatOrDepthTexture:!1,isExternalTexture:!1},r.isExternalTexture&&this._numExternalTextures--,r.isFloatOrDepthTexture&&this._numFloatOrDepthTextures--,t?(r.isFloatOrDepthTexture=t.type===1||t.format>=13&&t.format<=18,r.isExternalTexture=Tt.IsExternalTexture(t),r.isFloatOrDepthTexture&&this._numFloatOrDepthTextures++,r.isExternalTexture&&this._numExternalTextures++):(r.isFloatOrDepthTexture=!1,r.isExternalTexture=!1),r.texture=t;const i=n!==(t?.uniqueId??-1);i&&this.updateId++,this.isDirty||(this.isDirty=i)}}oe._Counter=0;class ue{isDirty(e){return this._isDirty||this._materialContextUpdateId!==e}resetIsDirty(e){this._isDirty=!1,this._materialContextUpdateId=e}get enableIndirectDraw(){return this._enableIndirectDraw}set enableIndirectDraw(e){this._enableIndirectDrawInCompatMode=!0,this._enableIndirectDraw!==e&&(this._enableIndirectDraw=e,!e&&!this._useInstancing&&this.indirectDrawBuffer?(this._bufferManager.releaseBuffer(this.indirectDrawBuffer),this.indirectDrawBuffer=void 0,this._indirectDrawData=void 0):e&&!this.indirectDrawBuffer&&(this.indirectDrawBuffer=this._bufferManager.createRawBuffer(20,C.CopyDst|C.Indirect|C.Storage,void 0,"IndirectDrawBuffer"),this._indirectDrawData=new Uint32Array(5),this._indirectDrawData[3]=0,this._indirectDrawData[4]=0))}get useInstancing(){return this._useInstancing}set useInstancing(e){if(this._useInstancing===e)return;this._useInstancing=e,this._currentInstanceCount=-1;const t=this._enableIndirectDrawInCompatMode;this.enableIndirectDraw=e,this._enableIndirectDrawInCompatMode=t}constructor(e,t){this._dummyIndexBuffer=t,this._enableIndirectDrawInCompatMode=!1,this._bufferManager=e,this.uniqueId=ue._Counter++,this._useInstancing=!1,this._currentInstanceCount=0,this._enableIndirectDraw=!1,this._vertexPullingEnabled=!1,this.reset()}reset(){this.buffers={},this._isDirty=!0,this._materialContextUpdateId=0,this.fastBundle=void 0,this.bindGroups=void 0,this._vertexPullingEnabled=!1}setBuffer(e,t){this._isDirty||(this._isDirty=t?.uniqueId!==this.buffers[e]?.uniqueId),this.buffers[e]=t}setIndirectData(e,t,r,n=!1){!n&&t===this._currentInstanceCount||!this.indirectDrawBuffer||!this._indirectDrawData||(this._currentInstanceCount=t,this._indirectDrawData[0]=e,this._indirectDrawData[1]=t,this._indirectDrawData[2]=r,this._bufferManager.setRawData(this.indirectDrawBuffer,0,this._indirectDrawData,0,20))}setVertexPulling(e,t,r,n,i){if(this._vertexPullingEnabled===e)return;this._vertexPullingEnabled=e,this._isDirty=!0;const a=t.shaderProcessingContext.bufferNames;if(i)for(const o in i){const u=i[o];if(!u||a.indexOf(o)===-1)continue;const c=u.effectiveBuffer;this.setBuffer(o,e?c:null)}for(const o in r){if(i&&o in i)continue;const u=r[o];if(!u||a.indexOf(o)===-1)continue;const c=u.effectiveBuffer;this.setBuffer(o,e?c:null)}a.indexOf("indices")!==-1&&this.setBuffer("indices",e?n??this._dummyIndexBuffer:null)}dispose(){this.indirectDrawBuffer&&(this._bufferManager.releaseBuffer(this.indirectDrawBuffer),this.indirectDrawBuffer=void 0,this._indirectDrawData=void 0),this.fastBundle=void 0,this.bindGroups=void 0,this.buffers=void 0,this._enableIndirectDraw=!1}}ue._Counter=0;const Lr=1<<20,Er=2**35;class J{constructor(){this.values={}}}class T{static get Statistics(){return{totalCreated:T.NumBindGroupsCreatedTotal,lastFrameCreated:T.NumBindGroupsCreatedLastFrame,lookupLastFrame:T.NumBindGroupsLookupLastFrame,noLookupLastFrame:T.NumBindGroupsNoLookupLastFrame}}static ResetCache(){T._Cache=new J,T.NumBindGroupsCreatedTotal=0,T.NumBindGroupsCreatedLastFrame=0,T.NumBindGroupsLookupLastFrame=0,T.NumBindGroupsNoLookupLastFrame=0,T._NumBindGroupsCreatedCurrentFrame=0,T._NumBindGroupsLookupCurrentFrame=0,T._NumBindGroupsNoLookupCurrentFrame=0}constructor(e,t,r){this.disabled=!1,this._device=e,this._cacheSampler=t,this._engine=r}endFrame(){T.NumBindGroupsCreatedLastFrame=T._NumBindGroupsCreatedCurrentFrame,T.NumBindGroupsLookupLastFrame=T._NumBindGroupsLookupCurrentFrame,T.NumBindGroupsNoLookupLastFrame=T._NumBindGroupsNoLookupCurrentFrame,T._NumBindGroupsCreatedCurrentFrame=0,T._NumBindGroupsLookupCurrentFrame=0,T._NumBindGroupsNoLookupCurrentFrame=0}getBindGroups(e,t,r){let n,i=T._Cache;const a=this.disabled||r.forceBindGroupCreation;if(!a){if(!t.isDirty(r.updateId)&&!r.isDirty)return T._NumBindGroupsNoLookupCurrentFrame++,t.bindGroups;for(const u of e.shaderProcessingContext.bufferNames){const c=(t.buffers[u]?.uniqueId??0)+Lr;let l=i.values[c];l||(l=new J,i.values[c]=l),i=l}for(const u of e.shaderProcessingContext.samplerNames){const c=r.samplers[u]?.hashCode??0;let l=i.values[c];l||(l=new J,i.values[c]=l),i=l}for(const u of e.shaderProcessingContext.textureNames){const c=(r.textures[u]?.texture?.uniqueId??0)+Er;let l=i.values[c];l||(l=new J,i.values[c]=l),i=l}n=i.bindGroups}if(t.resetIsDirty(r.updateId),r.isDirty=!1,n)return t.bindGroups=n,T._NumBindGroupsLookupCurrentFrame++,n;n=[],t.bindGroups=n,a||(i.bindGroups=n),T.NumBindGroupsCreatedTotal++,T._NumBindGroupsCreatedCurrentFrame++;const o=e.bindGroupLayouts[r.textureState];for(let u=0;u<e.shaderProcessingContext.bindGroupLayoutEntries.length;u++){const c=e.shaderProcessingContext.bindGroupLayoutEntries[u],l=e.shaderProcessingContext.bindGroupEntries[u];for(let d=0;d<c.length;d++){const f=e.shaderProcessingContext.bindGroupLayoutEntries[u][d],_=e.shaderProcessingContext.bindGroupLayoutEntryInfo[u][f.binding],g=_.nameInArrayOfTexture??_.name;if(f.sampler){const p=r.samplers[g];if(p){const m=p.sampler;if(!m){this._engine.dbgSanityChecks&&S.Error(`Trying to bind a null sampler! entry=${JSON.stringify(f)}, name=${g}, bindingInfo=${JSON.stringify(p,(b,x)=>b==="texture"?"<no dump>":x)}, materialContext.uniqueId=${r.uniqueId}`,50);continue}l[d].resource=this._cacheSampler.getSampler(m,!1,p.hashCode,m.label)}else S.Error(`Sampler "${g}" not found in the material context. Make sure you bound it. entry=${JSON.stringify(f)}, materialContext=${JSON.stringify(r,(m,b)=>m==="texture"||m==="sampler"?"<no dump>":b)}`,50)}else if(f.texture||f.storageTexture){const p=r.textures[g];if(p){if(this._engine.dbgSanityChecks&&p.texture===null){S.Error(`Trying to bind a null texture! name="${g}", entry=${JSON.stringify(f)}, bindingInfo=${JSON.stringify(p,(b,x)=>b==="texture"?"<no dump>":x)}, materialContext.uniqueId=${r.uniqueId}`,50);continue}const m=p.texture._hardwareTexture;if(this._engine.dbgSanityChecks&&(!m||f.texture&&!m.view||f.storageTexture&&!m.viewForWriting)){S.Error(`Trying to bind a null gpu texture or view! entry=${JSON.stringify(f)}, name=${g}, bindingInfo=${JSON.stringify(p,(b,x)=>b==="texture"?"<no dump>":x)}, isReady=${p.texture?.isReady}, materialContext.uniqueId=${r.uniqueId}`,50);continue}l[d].resource=f.storageTexture?m.viewForWriting:m.view}else S.Error(`Texture "${g}" not found in the material context. Make sure you bound it (something like effect.setTexture("${g}", texture)). entry=${JSON.stringify(f)}, materialContext=${JSON.stringify(r,(m,b)=>m==="texture"||m==="sampler"?"<no dump>":b)}`,50)}else if(f.externalTexture){const p=r.textures[g];if(p){if(this._engine.dbgSanityChecks&&p.texture===null){S.Error(`Trying to bind a null external texture! entry=${JSON.stringify(f)}, name=${g}, bindingInfo=${JSON.stringify(p,(b,x)=>b==="texture"?"<no dump>":x)}, materialContext.uniqueId=${r.uniqueId}`,50);continue}const m=p.texture.underlyingResource;if(this._engine.dbgSanityChecks&&!m){S.Error(`Trying to bind a null gpu external texture! entry=${JSON.stringify(f)}, name=${g}, bindingInfo=${JSON.stringify(p,(b,x)=>b==="texture"?"<no dump>":x)}, isReady=${p.texture?.isReady}, materialContext.uniqueId=${r.uniqueId}`,50);continue}l[d].resource=this._device.importExternalTexture({source:m})}else S.Error(`External texture "${g}" not found in the material context. Make sure you bound it. entry=${JSON.stringify(f)}, materialContext=${JSON.stringify(r,(m,b)=>m==="texture"||m==="sampler"?"<no dump>":b)}`,50)}else if(f.buffer){const p=t.buffers[g];if(p){const m=p.underlyingResource;l[d].resource.buffer=m,l[d].resource.size=p.capacity}else S.Error(`Can't find buffer "${g}" in the draw context. Make sure you bound it. entry=${JSON.stringify(f)}, buffers=${JSON.stringify(t.buffers)}, drawContext.uniqueId=${t.uniqueId}`,50)}}const h=o[u];n[u]=this._device.createBindGroup({layout:h,entries:l})}return n}}T.NumBindGroupsCreatedTotal=0;T.NumBindGroupsCreatedLastFrame=0;T.NumBindGroupsLookupLastFrame=0;T.NumBindGroupsNoLookupLastFrame=0;T._Cache=new J;T._NumBindGroupsCreatedCurrentFrame=0;T._NumBindGroupsLookupCurrentFrame=0;T._NumBindGroupsNoLookupCurrentFrame=0;const xt="clearQuadVertexShader",Or=`uniform depthValue: f32;const pos=array(
vec2f(-1.0,1.0),
vec2f(1.0,1.0),
vec2f(-1.0,-1.0),
vec2f(1.0,-1.0)
