import { n as ne$1 } from './prism-python-BaDPvmdn.js';

function M(){return {async:false,breaks:false,extensions:null,gfm:true,hooks:null,pedantic:false,renderer:null,silent:false,tokenizer:null,walkTokens:null}}let w=M();function fe(i){w=i;}const Ee=/[&<>"']/,Ne=new RegExp(Ee.source,"g"),Fe=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Oe=new RegExp(Fe.source,"g"),Le={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},W=i=>Le[i];function E(i,t){if(t){if(Ee.test(i))return i.replace(Ne,W)}else if(Fe.test(i))return i.replace(Oe,W);return i}const $e=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function ve(i){return i.replace($e,(t,e)=>(e=e.toLowerCase(),e==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):""))}const ze=/(^|[^\[])\^/g;function g(i,t){let e=typeof i=="string"?i:i.source;t=t||"";const n={replace:(u,s)=>{let r=typeof s=="string"?s:s.source;return r=r.replace(ze,"$1"),e=e.replace(u,r),n},getRegex:()=>new RegExp(e,t)};return n}function Q(i){try{i=encodeURI(i).replace(/%25/g,"%");}catch{return null}return i}const S={exec:()=>null};function J(i,t){const e=i.replace(/\|/g,(s,r,a)=>{let o=false,l=r;for(;--l>=0&&a[l]==="\\";)o=!o;return o?"|":" |"}),n=e.split(/ \|/);let u=0;if(n[0].trim()||n.shift(),n.length>0&&!n[n.length-1].trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push("");for(;u<n.length;u++)n[u]=n[u].trim().replace(/\\\|/g,"|");return n}function _(i,t,e){const n=i.length;if(n===0)return "";let u=0;for(;u<n&&i.charAt(n-u-1)===t;)u++;return i.slice(0,n-u)}function Pe(i,t){if(i.indexOf(t[1])===-1)return  -1;let e=0;for(let n=0;n<i.length;n++)if(i[n]==="\\")n++;else if(i[n]===t[0])e++;else if(i[n]===t[1]&&(e--,e<0))return n;return  -1}function ee(i,t,e,n){const u=t.href,s=t.title?E(t.title):null,r=i[1].replace(/\\([\[\]])/g,"$1");if(i[0].charAt(0)!=="!"){n.state.inLink=true;const a={type:"link",raw:e,href:u,title:s,text:r,tokens:n.inlineTokens(r)};return n.state.inLink=false,a}return {type:"image",raw:e,href:u,title:s,text:E(r)}}function Ue(i,t){const e=i.match(/^(\s+)(?:```)/);if(e===null)return t;const n=e[1];return t.split(`
`).map(u=>{const s=u.match(/^\s+/);if(s===null)return u;const[r]=s;return r.length>=n.length?u.slice(n.length):u}).join(`
`)}class N{options;rules;lexer;constructor(t){this.options=t||w;}space(t){const e=this.rules.block.newline.exec(t);if(e&&e[0].length>0)return {type:"space",raw:e[0]}}code(t){const e=this.rules.block.code.exec(t);if(e){const n=e[0].replace(/^ {1,4}/gm,"");return {type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?n:_(n,`
`)}}}fences(t){const e=this.rules.block.fences.exec(t);if(e){const n=e[0],u=Ue(n,e[3]||"");return {type:"code",raw:n,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:u}}}heading(t){const e=this.rules.block.heading.exec(t);if(e){let n=e[2].trim();if(/#$/.test(n)){const u=_(n,"#");(this.options.pedantic||!u||/ $/.test(u))&&(n=u.trim());}return {type:"heading",raw:e[0],depth:e[1].length,text:n,tokens:this.lexer.inline(n)}}}hr(t){const e=this.rules.block.hr.exec(t);if(e)return {type:"hr",raw:e[0]}}blockquote(t){const e=this.rules.block.blockquote.exec(t);if(e){let n=e[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);n=_(n.replace(/^ *>[ \t]?/gm,""),`
...
`,t=t.substring(v.length+1),D=p.slice(d);}}s.loose||(l?s.loose=true:/\n *\n *$/.test(a)&&(l=true));let f=null,m;this.options.gfm&&(f=/^\[[ xX]\] /.exec(o),f&&(m=f[0]!=="[ ] ",o=o.replace(/^\[[ xX]\] +/,""))),s.items.push({type:"list_item",raw:a,task:!!f,checked:m,loose:false,text:o,tokens:[]}),s.raw+=a;}s.items[s.items.length-1].raw=a.trimEnd(),s.items[s.items.length-1].text=o.trimEnd(),s.raw=s.raw.trimEnd();for(let c=0;c<s.items.length;c++)if(this.lexer.state.top=false,s.items[c].tokens=this.lexer.blockTokens(s.items[c].text,[]),!s.loose){const D=s.items[c].tokens.filter(d=>d.type==="space"),p=D.length>0&&D.some(d=>/\n.*\n/.test(d.raw));s.loose=p;}if(s.loose)for(let c=0;c<s.items.length;c++)s.items[c].loose=true;return s}}html(t){const e=this.rules.block.html.exec(t);if(e)return {type:"html",block:true,raw:e[0],pre:e[1]==="pre"||e[1]==="script"||e[1]==="style",text:e[0]}}def(t){const e=this.rules.block.def.exec(t);if(e){const n=e[1].toLowerCase().replace(/\s+/g," "),u=e[2]?e[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",s=e[3]?e[3].substring(1,e[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):e[3];return {type:"def",tag:n,raw:e[0],href:u,title:s}}}table(t){const e=this.rules.block.table.exec(t);if(!e||!/[:|]/.test(e[2]))return;const n=J(e[1]),u=e[2].replace(/^\||\| *$/g,"").split("|"),s=e[3]&&e[3].trim()?e[3].replace(/\n[ \t]*$/,"").split(`
`):[],r={type:"table",raw:e[0],header:[],align:[],rows:[]};if(n.length===u.length){for(const a of u)/^ *-+: *$/.test(a)?r.align.push("right"):/^ *:-+: *$/.test(a)?r.align.push("center"):/^ *:-+ *$/.test(a)?r.align.push("left"):r.align.push(null);for(const a of n)r.header.push({text:a,tokens:this.lexer.inline(a)});for(const a of s)r.rows.push(J(a,r.header.length).map(o=>({text:o,tokens:this.lexer.inline(o)})));return r}}lheading(t){const e=this.rules.block.lheading.exec(t);if(e)return {type:"heading",raw:e[0],depth:e[2].charAt(0)==="="?1:2,text:e[1],tokens:this.lexer.inline(e[1])}}paragraph(t){const e=this.rules.block.paragraph.exec(t);if(e){const n=e[1].charAt(e[1].length-1)===`
`?e[1].slice(0,-1):e[1];return {type:"paragraph",raw:e[0],text:n,tokens:this.lexer.inline(n)}}}text(t){const e=this.rules.block.text.exec(t);if(e)return {type:"text",raw:e[0],text:e[0],tokens:this.lexer.inline(e[0])}}escape(t){const e=this.rules.inline.escape.exec(t);if(e)return {type:"escape",raw:e[0],text:E(e[1])}}tag(t){const e=this.rules.inline.tag.exec(t);if(e)return !this.lexer.state.inLink&&/^<a /i.test(e[0])?this.lexer.state.inLink=true:this.lexer.state.inLink&&/^<\/a>/i.test(e[0])&&(this.lexer.state.inLink=false),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(e[0])?this.lexer.state.inRawBlock=true:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(e[0])&&(this.lexer.state.inRawBlock=false),{type:"html",raw:e[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:false,text:e[0]}}link(t){const e=this.rules.inline.link.exec(t);if(e){const n=e[2].trim();if(!this.options.pedantic&&/^</.test(n)){if(!/>$/.test(n))return;const r=_(n.slice(0,-1),"\\");if((n.length-r.length)%2===0)return}else {const r=Pe(e[2],"()");if(r>-1){const o=(e[0].indexOf("!")===0?5:4)+e[1].length+r;e[2]=e[2].substring(0,r),e[0]=e[0].substring(0,o).trim(),e[3]="";}}let u=e[2],s="";if(this.options.pedantic){const r=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(u);r&&(u=r[1],s=r[3]);}else s=e[3]?e[3].slice(1,-1):"";return u=u.trim(),/^</.test(u)&&(this.options.pedantic&&!/>$/.test(n)?u=u.slice(1):u=u.slice(1,-1)),ee(e,{href:u&&u.replace(this.rules.inline.anyPunctuation,"$1"),title:s&&s.replace(this.rules.inline.anyPunctuation,"$1")},e[0],this.lexer)}}reflink(t,e){let n;if((n=this.rules.inline.reflink.exec(t))||(n=this.rules.inline.nolink.exec(t))){const u=(n[2]||n[1]).replace(/\s+/g," "),s=e[u.toLowerCase()];if(!s){const r=n[0].charAt(0);return {type:"text",raw:r,text:r}}return ee(n,s,n[0],this.lexer)}}emStrong(t,e,n=""){let u=this.rules.inline.emStrongLDelim.exec(t);if(!u||u[3]&&n.match(/[\p{L}\p{N}]/u))return;if(!(u[1]||u[2]||"")||!n||this.rules.inline.punctuation.exec(n)){const r=[...u[0]].length-1;let a,o,l=r,c=0;const D=u[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(D.lastIndex=0,e=e.slice(-1*t.length+r);(u=D.exec(e))!=null;){if(a=u[1]||u[2]||u[3]||u[4]||u[5]||u[6],!a)continue;if(o=[...a].length,u[3]||u[4]){l+=o;continue}else if((u[5]||u[6])&&r%3&&!((r+o)%3)){c+=o;continue}if(l-=o,l>0)continue;o=Math.min(o,o+l+c);const p=[...u[0]][0].length,d=t.slice(0,r+u.index+p+o);if(Math.min(r,o)%2){const f=d.slice(1,-1);return {type:"em",raw:d,text:f,tokens:this.lexer.inlineTokens(f)}}const F=d.slice(2,-2);return {type:"strong",raw:d,text:F,tokens:this.lexer.inlineTokens(F)}}}}codespan(t){const e=this.rules.inline.code.exec(t);if(e){let n=e[2].replace(/\n/g," ");const u=/[^ ]/.test(n),s=/^ /.test(n)&&/ $/.test(n);return u&&s&&(n=n.substring(1,n.length-1)),n=E(n,true),{type:"codespan",raw:e[0],text:n}}}br(t){const e=this.rules.inline.br.exec(t);if(e)return {type:"br",raw:e[0]}}del(t){const e=this.rules.inline.del.exec(t);if(e)return {type:"del",raw:e[0],text:e[2],tokens:this.lexer.inlineTokens(e[2])}}autolink(t){const e=this.rules.inline.autolink.exec(t);if(e){let n,u;return e[2]==="@"?(n=E(e[1]),u="mailto:"+n):(n=E(e[1]),u=n),{type:"link",raw:e[0],text:n,href:u,tokens:[{type:"text",raw:n,text:n}]}}}url(t){let e;if(e=this.rules.inline.url.exec(t)){let n,u;if(e[2]==="@")n=E(e[0]),u="mailto:"+n;else {let s;do s=e[0],e[0]=this.rules.inline._backpedal.exec(e[0])?.[0]??"";while(s!==e[0]);n=E(e[0]),e[1]==="www."?u="http://"+e[0]:u=e[0];}return {type:"link",raw:e[0],text:n,href:u,tokens:[{type:"text",raw:n,text:n}]}}}inlineText(t){const e=this.rules.inline.text.exec(t);if(e){let n;return this.lexer.state.inRawBlock?n=e[0]:n=E(e[0]),{type:"text",raw:e[0],text:n}}}}const Me=/^(?: *(?:\n|$))+/,He=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,Ge=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,B=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,qe=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,be=/(?:[*+-]|\d{1,9}[.)])/,Ae=g(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,be).replace(/blockCode/g,/ {4}/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),H=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ze=/^[^\n]+/,G=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Xe=g(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label",G).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ye=g(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,be).getRegex(),$="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",q=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ke=g("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))","i").replace("comment",q).replace("tag",$).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ke=g(H).replace("hr",B).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",$).getRegex(),Ve=g(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",ke).getRegex(),Z={blockquote:Ve,code:He,def:Xe,fences:Ge,heading:qe,hr:B,html:Ke,lheading:Ae,list:Ye,newline:Me,paragraph:ke,table:S,text:Ze},te=g("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",B).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",$).getRegex(),je={...Z,table:te,paragraph:g(H).replace("hr",B).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",te).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",$).getRegex()},We={...Z,html:g(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",q).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:S,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:g(H).replace("hr",B).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Ae).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},me=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Qe=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Ce=/^( {2,}|\\)\n(?!\s*$)/,Je=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,y="\\p{P}\\p{S}",et=g(/^((?![*_])[\spunctuation])/,"u").replace(/punctuation/g,y).getRegex(),tt=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,nt=g(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,"u").replace(/punct/g,y).getRegex(),rt=g("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])","gu").replace(/punct/g,y).getRegex(),ut=g("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])","gu").replace(/punct/g,y).getRegex(),st=g(/\\([punct])/,"gu").replace(/punct/g,y).getRegex(),it=g(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),at=g(q).replace("(?:-->|$)","-->").getRegex(),ot=g("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",at).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),O=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,lt=g(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",O).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),we=g(/^!?\[(label)\]\[(ref)\]/).replace("label",O).replace("ref",G).getRegex(),xe=g(/^!?\[(ref)\](?:\[\])?/).replace("ref",G).getRegex(),ct=g("reflink|nolink(?!\\()","g").replace("reflink",we).replace("nolink",xe).getRegex(),X={_backpedal:S,anyPunctuation:st,autolink:it,blockSkip:tt,br:Ce,code:Qe,del:S,emStrongLDelim:nt,emStrongRDelimAst:rt,emStrongRDelimUnd:ut,escape:me,link:lt,nolink:xe,punctuation:et,reflink:we,reflinkSearch:ct,tag:ot,text:Je,url:S},pt={...X,link:g(/^!?\[(label)\]\((.*?)\)/).replace("label",O).getRegex(),reflink:g(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",O).getRegex()},U={...X,escape:g(me).replace("])","~|])").getRegex(),url:g(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},Dt={...U,br:g(Ce).replace("{2,}","*").getRegex(),text:g(U.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},R={normal:Z,gfm:je,pedantic:We},T={normal:X,gfm:U,breaks:Dt,pedantic:pt};class A{tokens;options;state;tokenizer;inlineQueue;constructor(t){this.tokens=[],this.tokens.links=Object.create(null),this.options=t||w,this.options.tokenizer=this.options.tokenizer||new N,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:false,inRawBlock:false,top:true};const e={block:R.normal,inline:T.normal};this.options.pedantic?(e.block=R.pedantic,e.inline=T.pedantic):this.options.gfm&&(e.block=R.gfm,this.options.breaks?e.inline=T.breaks:e.inline=T.gfm),this.tokenizer.rules=e;}static get rules(){return {block:R,inline:T}}static lex(t,e){return new A(e).lex(t)}static lexInline(t,e){return new A(e).inlineTokens(t)}lex(t){t=t.replace(/\r\n|\r/g,`
...
`,Bt=`<svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" aria-hidden="true" aria-label="Copied" fill="none" stroke="currentColor" stroke-width="1.3">
  <path d="m13.813 4.781 -7.438 7.438 -3.188 -3.188"/>
</svg>
`,he=`<button title="copy" class="copy_code_button">
  <span class="copy-text">${St}</span>
  <span class="check">${Bt}</span>
</button>`,Re=/[&<>"']/,yt=new RegExp(Re.source,"g"),Ie=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,_t=new RegExp(Ie.source,"g"),Rt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},ge=i=>Rt[i]||"";function P(i,t){if(t){if(Re.test(i))return i.replace(yt,ge)}else if(Ie.test(i))return i.replace(_t,ge);return i}function It(i){const t=i.map(e=>({start:new RegExp(e.left.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")),end:new RegExp(e.right.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&"))}));return {name:"latex",level:"block",start(e){for(const n of t){const u=e.match(n.start);if(u)return u.index}return  -1},tokenizer(e,n){for(const u of t){const s=new RegExp(`${u.start.source}([\\s\\S]+?)${u.end.source}`).exec(e);if(s)return {type:"latex",raw:s[0],text:s[1].trim()}}},renderer(e){return `<div class="latex-block">${e.text}</div>`}}}function Nt(){return {name:"mermaid",level:"block",start(i){return i.match(/^```mermaid\s*\n/)?.index},tokenizer(i){const t=/^```mermaid\s*\n([\s\S]*?)```\s*(?:\n|$)/.exec(i);if(t)return {type:"mermaid",raw:t[0],text:t[1].trim()}},renderer(i){return `<div class="mermaid">${i.text}</div>
`}}}const Ot={code(i,t,e){const n=(t??"").match(/\S*/)?.[0]??"";return i=i.replace(/\n$/,"")+`
`,!n||n==="mermaid"?'<div class="code_wrap">'+he+"<pre><code>"+(e?i:P(i,true))+`</code></pre></div>
`:'<div class="code_wrap">'+he+'<pre><code class="language-'+P(n)+'">'+(e?i:P(i,true))+`</code></pre></div>
`}},Lt=new K;function vt({header_links:i,line_breaks:t,latex_delimiters:e}){const n=new Te;n.use({gfm:true,pedantic:false,breaks:t},dt({highlight:(r,a)=>ne$1.languages?.[a]?ne$1.highlight(r,ne$1.languages[a],a):r}),{renderer:Ot}),i&&(n.use(At()),n.use({extensions:[{name:"heading",level:"block",renderer(r){const a=r.raw.toLowerCase().trim().replace(/<[!\/a-z].*?>/gi,""),o="h"+Lt.slug(a),l=r.depth,c=this.parser.parseInline(r.tokens);return `<h${l} id="${o}"><a class="md-header-anchor" href="#${o}">${Tt}</a>${c}</h${l}>
`}}]}));const u=Nt(),s=It(e);return n.use({extensions:[u,s]}),n}

export { vt as v };
//# sourceMappingURL=MarkdownCode.svelte_svelte_type_style_lang-DJRtJayx.js.map
